  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        elegant: "var(--shadow-premium)",
        primary: "0 0 15px hsl(var(--primary) / 0.3)",
        success: "0 0 15px hsl(var(--success) / 0.3)",
        warning: "0 0 15px hsl(var(--warning) / 0.3)",
        destructive: "0 0 15px hsl(var(--destructive) / 0.3)",
        orange: "0 0 15px hsl(var(--orange) / 0.3)",
        black: "0 0 15px hsl(0 0% 0% / 0.3)",
