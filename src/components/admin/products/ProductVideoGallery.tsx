...
export function ProductVideoGallery({ productId }: ProductVideoGalleryProps) {
  ...
  return (
    <div className="space-y-4">
      {/* Filter bar */}
      {g.videos.length > 0 && (
        <div className="flex flex-wrap items-center gap-2 p-2.5 rounded-2xl bg-muted/20 border border-border/30">
      ...
      {/* Stats */}
      {g.videos.length > 0 && (
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-[11px] text-muted-foreground px-1 py-1.5 rounded-2xl bg-muted/20 border border-border/30">
