...
export function ProductVideoGallery({ productId }: ProductVideoGalleryProps) {
  ...
  return (
    <div className="space-y-4">
      {/* Filter bar */}
      {g.videos.length > 0 && (
        <div className="flex flex-wrap items-center gap-2 rounded-xl border border-border/30 bg-muted/20 p-2.5">
      ...
      {/* Stats */}
      {g.videos.length > 0 && (
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 rounded-xl border border-border/30 bg-muted/20 px-1 py-1.5 text-[11px] text-muted-foreground">
