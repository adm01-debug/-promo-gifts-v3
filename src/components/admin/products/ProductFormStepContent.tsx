...
import { Loader2, Package, Layers, Info, Boxes, Wand2 } from 'lucide-react';
      ...
      return (
        <>
          <SectionCard id="kit-flag" title="Tipo de Produto" icon={Package} subtitle="Defina se este produto é um kit">
            <div
              className={cn(
                'flex items-center justify-between rounded-2xl border p-3 transition-all duration-200 cursor-pointer hover:bg-accent/30',
