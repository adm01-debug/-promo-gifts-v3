  ...
  return (
    <SectionCard id="seo" title="SEO e Metadados" icon={Globe} subtitle="Otimize o produto para buscadores">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <FieldLabel htmlFor="slug" hint="URL amigável do produto. Gerado automaticamente a partir do nome se vazio.">Slug (URL)</FieldLabel>
          <Input id="slug" {...register('slug')} placeholder="caneta-plastica-001" className="font-mono h-9" />
        </div>
        <div>
          <FieldLabel htmlFor="canonical_url" hint="URL canônica para evitar conteúdo duplicado em buscadores.">URL Canônica</FieldLabel>
