  ...
  const renderDetailsStep = () => {
    ...
    return (
      <div className="space-y-4">
        ...
        {(maxCores || custoSetup) && (
          <div className="flex items-center gap-4 text-xs p-2 rounded-lg bg-muted/20 border border-border/20">
            ...
            <motion.div key="list" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} transition={{ duration: 0.2 }} className="space-y-3">
              ...
              {w.displayAreas.length === 0 && (
                <div className="text-center py-10 border border-dashed border-border/50 rounded-lg">
                  <div className="w-14 h-14 rounded-lg bg-primary/10 flex items-center justify-center mx-auto mb-3"><Paintbrush className="h-7 w-7 text-primary" /></div>
