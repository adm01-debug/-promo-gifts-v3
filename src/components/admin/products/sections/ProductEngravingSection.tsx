      ...
      <div className="grid grid-cols-3 gap-2">
        {COMMON_COMPONENTS.map((comp) => (
          <button
            ...
            className="flex items-center gap-2.5 rounded-xl border border-border/40 bg-card/60 p-3 text-left transition-all duration-200 hover:border-primary/50 hover:bg-primary/5 hover:shadow-sm"
          >
                  ...
                  {techs.map((tech) => {
                    ...
                    return (
                      <button
                        ...
                        className={cn(
                          'flex items-center gap-2 rounded-xl border p-2.5 text-left transition-all duration-200 hover:scale-[1.01] hover:shadow-md',
  ...
  const renderDetailsStep = () => {
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-1.5 rounded-xl border border-border/30 bg-muted/30 p-2.5 text-xs">
        ...
        {(maxCores || custoSetup) && (
          <div className="flex items-center gap-4 rounded-xl border border-border/20 bg-muted/20 p-2 text-xs">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="flex items-end gap-3">
            <div className="flex items-center gap-2 pb-1">
              ...
              />
              <span className="text-[11px] text-muted-foreground">Superfície curva</span>
            </div>
          </div>
        </div>
        <div>
        ...
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-[11px] text-muted-foreground">Área ativa</span>
        </div>
