                  ...
                  <div className="absolute inset-0 flex items-center justify-center gap-1 bg-black/50 opacity-0 transition-opacity group-hover:opacity-100">
                    {item.media_type === 'image' && !item.is_cover && (
                      <button
                        ...
                        className="rounded-xl bg-white/20 p-1.5 text-primary-foreground transition-colors hover:bg-white/30"
                    ...
                    <button
                      ...
                      className="rounded-xl bg-destructive/60 p-1.5 text-primary-foreground transition-colors hover:bg-destructive/80"
                      title="Excluir"
                    >
