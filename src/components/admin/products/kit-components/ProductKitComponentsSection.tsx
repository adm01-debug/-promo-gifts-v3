...
<img src={comp.primary_image_url} alt={comp.component_name || ''} className="w-10 h-10 rounded-lg object-contain border shrink-0 bg-muted/30"  loading="lazy" />
                  ) : (
                    <div className="w-10 h-10 rounded-lg border shrink-0 bg-muted flex items-center justify-center">
