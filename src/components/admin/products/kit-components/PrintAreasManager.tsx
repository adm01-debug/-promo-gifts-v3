      ...
      <Collapsible open={isOpen} onOpenChange={setIsOpen}>
        <CollapsibleTrigger asChild>
          <button
            type="button"
            className={cn(
              'flex items-center gap-1.5 text-[10px] px-2 py-1 rounded-2xl transition-colors',
        ...
        <CollapsibleContent>
          <div className="ml-6 mt-1.5 space-y-1.5">
            ...
            {areas.map((area) => {
              ...
              return (
                <div key={area.id} className="flex items-center gap-2 rounded-2xl border border-border/50 p-1.5 text-[10px] group hover:bg-accent/30 transition-colors">
