            ...
            return (
              ...
              >
                ...
                {hoveredStep === i && hasMissing && (
                  <div className="absolute left-1/2 top-full z-50 mt-2 w-max max-w-[220px] -translate-x-1/2 animate-fade-in rounded-xl border border-border bg-popover p-2.5 shadow-lg">
