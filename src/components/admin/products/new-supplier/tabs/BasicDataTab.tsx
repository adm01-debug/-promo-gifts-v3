...
<img src={form.logoUrl} alt="Logo" className="w-full h-full object-contain"  loading="lazy" />
            ...
            <button type="button" onClick={() => form.logoInputRef.current?.click()} disabled={form.uploadingLogo} className="w-20 h-20 rounded-2xl border-2 border-dashed border-border hover:border-primary/50 flex flex-col items-center justify-center gap-1 text-muted-foreground hover:text-primary transition-colors">
