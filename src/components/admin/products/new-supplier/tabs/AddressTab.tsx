    ...
    <div className="space-y-3 pt-3">
      ...
      <div>
        ...
        <Input
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) => form.setLogradouro(e.target.value)}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            value={form.numero}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => form.setNumero(e.target.value)}
            placeholder="123"
            className={fieldClass}
          />
        </div>
        <div>
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              form.setComplemento(e.target.value)
            }
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            value={form.bairro}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => form.setBairro(e.target.value)}
            placeholder="Centro"
            className={fieldClass}
          />
        </div>
        <div>
          ...
          <Input
            value={form.cidade}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => form.setCidade(e.target.value)}
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <Input
            value={form.pais}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => form.setPais(e.target.value)}
            className={fieldClass}
          />
        </div>
      </div>
      <div>
        ...
        <Input
          ...
          onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
            form.setPontoReferencia(e.target.value)
          }
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            step="any"
            value={form.latitude}
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => form.setLatitude(e.target.value)}
            placeholder="-23.5505"
            className={`${fieldClass} font-mono`}
          />
        </div>
        <div>
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) => form.setLongitude(e.target.value)}
            placeholder="-46.6333"
            className={`${fieldClass} font-mono`}
          />
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              form.setGoogleMapsUrl(e.target.value)
            }
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
              form.setGooglePlaceId(e.target.value)
            }
            placeholder="ChIJ..."
            className={fieldClass}
          />
        ...
        {form.transportadoraPadrao ? (
          ...
          <div className="relative mt-1">
            ...
            {form.showCarrierDropdown && form.carrierResults.length > 0 && (
              <div className="absolute z-50 mt-1 max-h-48 w-full overflow-y-auto rounded-xl border bg-popover shadow-lg">
