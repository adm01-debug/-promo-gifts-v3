    ...
    <div className="space-y-3 pt-3">
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          ...
          <select value={form.tipoLogradouro} onChange={(e) => form.setTipoLogradouro(e.target.value)} className="mt-1.5 h-9 w-full rounded-lg border border-input bg-background px-3 text-sm">
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <select value={form.estado} onChange={(e) => form.setEstado(e.target.value)} className="mt-1.5 h-9 w-full rounded-lg border border-input bg-background px-3 text-sm">
            <option value="">Selecione</option>
