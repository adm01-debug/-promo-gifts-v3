  ...
  return (
    <div className="space-y-2">
      <div className="flex flex-wrap items-center gap-2">
        {/* View mode pills */}
        <div className="flex items-center gap-1 rounded-xl border border-border/40 bg-muted/50 p-0.5">
          <button
            type="button"
            onClick={() => setFilterMode('all')}
            className={cn(
              'rounded-xl px-2.5 py-1 text-[11px] font-medium transition-all',
              filterMode === 'all'
          ...
          {hasVariants && (
            <button
              ...
              className={cn(
                'flex items-center gap-1 rounded-xl px-2.5 py-1 text-[11px] font-medium transition-all',
