      ...
      <div className="flex flex-wrap items-center gap-2 border-b border-border/30 bg-muted/30 px-3 py-2.5">
        {productId && variants.length > 0 && (
          <Select value={uploadVariant} onValueChange={setUploadVariant}>
            <SelectTrigger className="h-8 w-auto min-w-[180px] gap-1.5 rounded-xl border-border/40 bg-background/60 text-xs transition-colors hover:bg-background/80">
        ...
        {(activeVariant || uploadImageType !== 'gallery') && (
          <div className="flex items-center gap-1.5 rounded-xl bg-primary/10 px-2 py-1 text-[10px] font-medium text-primary/80">
            {activeVariant && (
