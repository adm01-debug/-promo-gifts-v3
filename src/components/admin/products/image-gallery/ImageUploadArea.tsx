      ...
      <div className="flex flex-wrap items-center gap-2 px-3 py-2.5 bg-muted/30 border-b border-border/30">
        {productId && variants.length > 0 && (
          <Select value={uploadVariant} onValueChange={setUploadVariant}>
            <SelectTrigger className="h-8 w-auto min-w-[180px] gap-1.5 text-xs rounded-lg bg-background/60 border-border/40 hover:bg-background/80 transition-colors">
        ...
        {(activeVariant || uploadImageType !== 'gallery') && (
          <div className="flex items-center gap-1.5 px-2 py-1 rounded-lg bg-primary/10 text-[10px] text-primary/80 font-medium">
            {activeVariant && (
