      ...
      {images.length > 1 && (
        <div className="flex gap-1.5 px-1">
          {images.slice(0, 4).map((img, i) => (
            <div
              key={i}
              className="w-10 h-10 rounded-2xl overflow-hidden border border-border/50 bg-muted/30"
            >
              <img
          ...
          {images.length > 4 && (
            <div className="w-10 h-10 rounded-2xl border border-border/50 bg-muted/30 flex items-center justify-center">
