...
export function GroupAccordionItem({
  ...
  return (
    <AccordionItem value={group.id} className="border rounded-md px-4">
      ...
      <AccordionContent className="pt-4 pb-2">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-muted/30 rounded-md mb-4">
              ...
              <DialogContent className="max-w-2xl max-h-[80vh]">
                ...
                <div className="max-h-96 overflow-y-auto space-y-2">
                  {availableProducts.length === 0 ? (
                    ...
                    <div key={product.id} className="flex items-center justify-between p-3 border rounded-md hover:bg-muted/50 cursor-pointer" onClick={() => onAddMember({ product_group_id: group.id, product_id: product.id })}>
