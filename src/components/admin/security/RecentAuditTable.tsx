      ...
      <CardHeader className="flex flex-row items-start justify-between gap-3">
        <div>
          <CardTitle className="flex items-center gap-2 text-base font-bold">
            <History className="h-5 w-5 text-primary" /> Auditoria Recente
          </CardTitle>
          <CardDescription className="text-[11px] font-medium">
            Ações administrativas registradas (50 últimas) — atualiza 30s
          </CardDescription>
        </div>
          ...
          {selected && (
            <div className="space-y-3 text-sm">
              ...
              <div>
                ...
                <pre className="mt-1 max-h-[300px] overflow-auto rounded-xl bg-muted p-3 text-xs">
