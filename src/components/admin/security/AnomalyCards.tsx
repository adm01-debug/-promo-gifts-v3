    ...
    <div className="space-y-3">
      <div className="grid gap-3 md:grid-cols-4">
        {cards.map((c) => (
          <Card
            key={c.label}
            className="glass-premium border-[1.5px] bg-card/40 transition-colors hover:bg-card/60"
          >
            <CardContent className="p-4 py-5">
              ...
              <p className="mt-1.5 text-[10px] font-bold uppercase tracking-[0.15em] text-muted-foreground/60">
                Últimas 24h
              </p>
            </CardContent>
          </Card>
