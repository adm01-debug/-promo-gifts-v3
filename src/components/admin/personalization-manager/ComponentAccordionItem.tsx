...
export function ComponentAccordionItem({
  ...
  return (
    <SortableItem key={component.id} id={component.id}>
      <AccordionItem value={component.id} className="border rounded-md px-4">
        ...
        <AccordionContent className="pt-4 pb-2">
          {/* Component fields */}
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-4 bg-muted/30 rounded-md mb-4">
            <div>
            ...
            {compLocations.length === 0 ? (
              ...
              <div className="space-y-3 pl-6">
                {compLocations.map((location) => (
                  <div key={location.id} className="border rounded-md p-3 bg-muted/30">
