                          ...
                          {product.images && product.images.length > 0 ? (
                            <div className="relative">
                              <img
                                ...
                                alt={product.name}
                                className="h-12 w-12 rounded-xl border border-border/50 object-cover transition-colors group-hover:border-primary/30"
                                loading="lazy"
                              />
                            ...
                            <div className="flex h-12 w-12 items-center justify-center rounded-xl border border-dashed border-border/60 bg-muted/50">
