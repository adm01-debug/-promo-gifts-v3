      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          <h2 className="font-display text-2xl font-bold tracking-tight flex items-center gap-2.5">
            <div className="p-2 rounded-md bg-primary/10"><Package className="h-5 w-5 text-primary" /></div>
                        ...
                        <TableCell>
                          {product.images && product.images.length > 0 ? (
                            <div className="relative">
                              <img src={product.images[0]} alt={product.name} className="w-12 h-12 object-cover rounded-md border border-border/50 group-hover:border-primary/30 transition-colors" loading="lazy" />
                            ...
                            <div className="w-12 h-12 bg-muted/50 rounded-md border border-dashed border-border/60 flex items-center justify-center"><ImageIcon className="h-4 w-4 text-muted-foreground/50" /></div>
                          )}
                        </TableCell>
