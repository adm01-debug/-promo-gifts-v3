      ...
      <DialogContent className="max-w-xl">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="max-h-[200px] overflow-auto whitespace-pre-wrap rounded-xl border bg-muted/50 p-3 font-mono text-xs">
          ...
          {detail && (
            <Collapsible>
              ...
              <CollapsibleContent className="mt-2">
                <pre className="max-h-[400px] overflow-auto whitespace-pre-wrap rounded-xl border bg-muted/30 p-3 text-[11px] text-muted-foreground">
                  {JSON.stringify(
                    {
                      id: detail.id,
          ...
          {suggestion && (
            <div
              className={cn(
                'flex items-start gap-2 rounded-xl border border-primary/20 bg-primary/5 p-3 text-xs',
              )}
            >
