      ...
      <DialogContent className="max-w-xl">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="rounded-lg border bg-muted/50 p-3 text-xs font-mono whitespace-pre-wrap max-h-[200px] overflow-auto">
          ...
          {detail && (
            <Collapsible>
              ...
              <CollapsibleContent className="mt-2">
                <pre className="rounded-lg border bg-muted/30 p-3 text-[11px] text-muted-foreground whitespace-pre-wrap max-h-[400px] overflow-auto">
{JSON.stringify({
  id: detail.id,
  ...
  error_message: detail.error_message,
          ...
          {/* Sugestão */}
          {suggestion && (
            <div className={cn("flex items-start gap-2 rounded-lg border border-primary/20 bg-primary/5 p-3 text-xs")}>
