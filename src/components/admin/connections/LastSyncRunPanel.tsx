    ...
    <Card>
      ...
      <CardContent>
        {loading ? (
          ...
          <div className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-3 text-sm text-amber-700 dark:text-amber-400">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap rounded-2xl border p-3 bg-muted/20">
            ...
            <div className="grid gap-2 md:grid-cols-4">
              ...
              <div className="rounded-2xl border p-3 bg-green-500/5 border-green-500/20">
              ...
              <div className="rounded-2xl border p-3 bg-blue-500/5 border-blue-500/20">
