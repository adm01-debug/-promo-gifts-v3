  ...
  return (
    <Card className={className} data-testid="secrets-manager-health-panel">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center gap-3 flex-wrap rounded-2xl border bg-muted/20 px-3 py-2">
          <Badge
            variant="outline"
...
function SampleRow({ sample }: { sample: SecretsManagerCallSample }) {
  ...
  return (
    <li
      className={`flex items-center gap-2 rounded-2xl border ${tone} px-2 py-1.5 text-xs flex-wrap`}
    >
      <Badge
        variant="outline"
