  ...
  return (
    <Card className={className} data-testid="secrets-manager-health-panel">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-3 rounded-xl border bg-muted/20 px-3 py-2">
...
function SampleRow({ sample }: { sample: SecretsManagerCallSample }) {
  ...
  return (
    <li
      className={`flex items-center gap-2 rounded-xl border ${tone} flex-wrap px-2 py-1.5 text-xs`}
    >
      <Badge
        variant="outline"
