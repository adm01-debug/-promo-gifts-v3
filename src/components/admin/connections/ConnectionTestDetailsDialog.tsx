          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as typeof tab)}>
            ...
            <TabsContent value="resumo" className="space-y-3">
              ...
              {!details.ok && (() => {
                ...
                return (
                  <div
                    role="alert"
                    className="rounded-2xl border border-destructive/30 bg-destructive/5 p-3 space-y-2"
                  >
            ...
            <TabsContent value="http" className="space-y-3 text-sm">
              <div className="grid grid-cols-[80px_1fr] gap-2 items-baseline">
                ...
                <span
                  className={cn(
                    "inline-flex items-center rounded-2xl border px-1.5 py-0.5 text-xs font-mono w-fit",
              ...
              {details.response.headers && Object.keys(details.response.headers).length > 0 && (
                <div>
                  ...
                  <pre className="rounded-2xl border bg-muted/50 p-2 text-[11px] font-mono max-h-[180px] overflow-auto">
            ...
            <TabsContent value="timing" className="space-y-3">
              {segs.length === 0 ? (
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground rounded-2xl border border-dashed p-3">
            ...
            <TabsContent value="resposta" className="space-y-2">
              {!maskedBody ? (
                ...
                <>
                  ...
                  <pre className="rounded-2xl border bg-muted/50 p-3 text-[11px] font-mono whitespace-pre-wrap break-words max-h-[360px] overflow-auto">
