...
import { useConnectionTestDetails, type TestDetails } from '@/hooks/useConnectionTestDetails';
          ...
          <Tabs value={tab} onValueChange={(v) => setTab(v as typeof tab)}>
            ...
            <TabsContent value="http" className="space-y-3 text-sm">
              <div className="grid grid-cols-[80px_1fr] items-baseline gap-2">
                ...
                <span
                  className={cn(
                    'inline-flex w-fit items-center rounded-xl border px-1.5 py-0.5 font-mono text-xs',
              ...
              {details.response.headers && Object.keys(details.response.headers).length > 0 && (
                <div>
                  ...
                  <pre className="max-h-[180px] overflow-auto rounded-xl border bg-muted/50 p-2 font-mono text-[11px]">
            ...
            <TabsContent value="resposta" className="space-y-2">
              {!maskedBody ? (
                ...
                <>
                  ...
                  <pre className="max-h-[360px] overflow-auto whitespace-pre-wrap break-words rounded-xl border bg-muted/50 p-3 font-mono text-[11px]">
