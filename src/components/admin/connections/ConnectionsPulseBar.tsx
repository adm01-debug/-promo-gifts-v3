...
function MiniKpi({
  ...
  const content = (
    <div
      className={cn(
        'flex min-w-0 items-center gap-1.5 rounded-xl border bg-background/60 px-2.5 py-1 transition-colors',
        ...
        <div className="flex flex-wrap items-center gap-x-4 gap-y-2">
          ...
          <div className="flex flex-wrap items-center gap-1.5">
            ...
            <button
              type="button"
              onClick={() => refetch()}
              className="ml-1 inline-flex items-center gap-1 rounded-xl border border-border/50 bg-background/60 px-2 py-1 text-[11px] text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground"
