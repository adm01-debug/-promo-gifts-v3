              ...
              <div className="relative shrink-0">
                {editingSupplier.logo_url ? (
                  ...
                  <button
                    ...
                    className="flex h-20 w-20 flex-col items-center justify-center gap-1 rounded-xl border-2 border-dashed border-border text-muted-foreground transition-colors hover:border-primary/50 hover:text-primary"
                  >
                    {uploadingLogo ? (
          ...
          <TabsContent value="contact" className="space-y-3 pt-3">
            <div className="mb-1 flex items-center justify-between">
              <p className="text-[11px] text-muted-foreground">
                Adicione os contatos do fornecedor
              </p>
              <Button
                type="button"
                variant="outline"
