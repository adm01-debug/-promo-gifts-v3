          ...
          <div className="grid max-h-[500px] grid-cols-2 gap-2 overflow-y-auto">
            {history.map((item) => (
              <div
                ...
                tabIndex={0}
                key={item.id}
                className="group relative cursor-pointer overflow-hidden rounded-xl border text-left transition-all hover:ring-2 hover:ring-primary/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
