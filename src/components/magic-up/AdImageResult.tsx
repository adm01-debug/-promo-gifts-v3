          ...
          <div className="grid grid-cols-2 gap-2 max-h-[500px] overflow-y-auto">
            {history.map((item) => (
              <div
                ...
                tabIndex={0}
                key={item.id}
                className="relative group rounded-md overflow-hidden border cursor-pointer hover:ring-2 hover:ring-primary/30 transition-all text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
