...
export function MagicUpVariationComparator({ variations, activeIndex, onSelect, onSelectWinner, loadingWinnerIndex = null }: MagicUpVariationComparatorProps) {
  ...
  return (
    <section data-testid="magic-up-variation-comparator" className="rounded-2xl border bg-card p-3" aria-label="Comparador de variações">
        ...
        {variations.map((variation, index) => {
          ...
          return (
            <div
              ...
              className={cn("overflow-hidden rounded-2xl border", isActive ? "border-primary ring-2 ring-primary/20" : "border-border hover:border-primary/40")}
            >
              <button
