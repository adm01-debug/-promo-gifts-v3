      ...
      <div className={cn(
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex items-center gap-2 min-w-0">
            <div className="p-1.5 rounded-2xl bg-primary/10 shrink-0">
        ...
        {enabled && (
          <>
            ...
            <div className="grid grid-cols-2 gap-2 pt-2 border-t border-border/40">
              {/* Real (interno) */}
              <div className="rounded-2xl bg-muted/40 p-2 space-y-1">
              ...
              {/* Cliente vê */}
              <div className="rounded-2xl bg-primary/5 border border-primary/20 p-2 space-y-1">
            ...
            {maxDiscountPercent != null && (
              isOverLimit ? (
                <div className="flex items-start gap-2 rounded-2xl bg-warning/10 border border-warning/30 px-2.5 py-1.5">
                ...
                <div className="flex items-start gap-2 rounded-2xl bg-success/10 border border-success/30 px-2.5 py-1.5">
