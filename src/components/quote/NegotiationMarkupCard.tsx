      ...
      >
        ...
        <div className="flex items-start justify-between gap-2">
          <div className="flex min-w-0 items-center gap-2">
            <div className="shrink-0 rounded-xl bg-primary/10 p-1.5">
        ...
        {enabled && (
          <>
            ...
            <div className="grid grid-cols-2 gap-2 border-t border-border/40 pt-2">
              ...
              {/* Cliente vê */}
              <div className="space-y-1 rounded-xl border border-primary/20 bg-primary/5 p-2">
            ...
            {maxDiscountPercent != null &&
              (isOverLimit ? (
                <div className="flex items-start gap-2 rounded-xl border border-warning/30 bg-warning/10 px-2.5 py-1.5">
                ...
                <div className="flex items-start gap-2 rounded-xl border border-success/30 bg-success/10 px-2.5 py-1.5">
