            ...
            {lists.map((l) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "w-full flex items-center gap-2 rounded-2xl px-2 py-1.5 text-sm text-left transition-colors",
                    "hover:bg-muted",
        ...
        <div className="border-t mt-1 pt-1">
          {creating ? (
            ...
            <button
              ...
              className="w-full flex items-center gap-2 rounded-2xl px-2 py-1.5 text-xs text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
            >
