  ...
  const handleApplyPreset = useCallback(
    (preset: FilterPreset) => {
      try {
        ...
        toast.error('Falha ao aplicar preset', {
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <Tooltip>
                ...
                >
                  Salvar combinação atual como preset
                </TooltipContent>
              </Tooltip>
            </div>
            ...
            {activePresetId && presets.find((p) => p.id === activePresetId) && (
              <div className="flex items-center gap-2 rounded-xl border border-primary/20 bg-primary/10 px-2.5 py-1.5 text-xs">
                    ...
                    <Tooltip key={preset.id}>
                      <TooltipTrigger asChild>
                        <div
                          ...
                          className={cn(
                            'group flex cursor-pointer items-center gap-2 rounded-xl py-2 pl-0 pr-2 transition-all hover:bg-accent',
                            isActive
                      ...
                      <TooltipContent
                        side="left"
                        className="max-w-52 border-none bg-primary px-2 py-1 text-[11px] text-primary-foreground"
                      >
                        {summary}
                      </TooltipContent>
                    </Tooltip>
