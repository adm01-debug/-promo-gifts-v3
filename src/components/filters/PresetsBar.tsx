          ...
          <PopoverContent align="end" className="w-80 p-3" sideOffset={8}>
            <div className="space-y-3">
              ...
              {activePresetId && presets.find(p => p.id === activePresetId) && (
                <div className="flex items-center gap-2 px-2.5 py-1.5 rounded-2xl bg-primary/10 border border-primary/20 text-xs">
                      ...
                      <Tooltip key={preset.id}>
                        <TooltipTrigger asChild>
                          <div
                            ...
                            className={cn(
                              "group flex items-center gap-2 pl-0 pr-2 py-2 rounded-2xl transition-all cursor-pointer hover:bg-accent",
                          ...
                          >
                            ...
                            {/* Icon */}
                            <div
                              className="w-7 h-7 rounded-2xl flex items-center justify-center shrink-0 text-sm"
