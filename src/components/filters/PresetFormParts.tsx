        ...
        <div className="flex flex-wrap gap-1.5">
          {PRESET_EMOJIS.map((e) => (
            <button
              ...
              className={cn(
                "w-8 h-8 rounded-2xl text-base flex items-center justify-center transition-all",
...
export function PresetPreviewHeader({
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-2xl bg-muted/50 border border-border/50">
      <div
        className="w-10 h-10 rounded-2xl flex items-center justify-center text-xl shrink-0 transition-colors"
