      ...
      >
        ...
        >
          <div className="flex min-w-0 flex-1 items-center gap-2.5">
            ...
            {hasActive && !isOpen && (
              <span className="inline-flex h-5 min-w-5 shrink-0 animate-scale-in items-center justify-center rounded-full bg-orange px-1.5 text-[10px] font-bold text-orange-foreground">
                {activeCount}
              </span>
            )}
            {tooltip && (
              <Tooltip>
                ...
                <TooltipContent
                  side="right"
                  className="z-[100] max-w-48 border-none bg-primary px-2 py-1 text-[11px] text-primary-foreground"
                >
                  {tooltip}
                </TooltipContent>
              </Tooltip>
