...
export function PublicoFilter({
  ...
  if (publicoAlvoOptions.length === 0)
    return <p className="text-[11px] text-muted-foreground">Carregando opções dos produtos...</p>;
  return (
...
export function QuickOptionsFilter({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 rounded-xl border border-warning/20 bg-warning/5 p-2">
        <Checkbox
