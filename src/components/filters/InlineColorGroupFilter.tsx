  ...
  return (
    <div className="relative">
      <Tooltip>
        ...
        <TooltipContent
          side="top"
          className="border-primary bg-primary px-2 py-1 text-[11px] text-primary-foreground"
        >
          {label}
        ...
        {showVariations &&
          colorData.groups
            ...
            .map((group) => (
              <div
                key={group.id}
                className="space-y-2 rounded-xl border border-border/50 bg-muted/20 p-2.5"
              >
