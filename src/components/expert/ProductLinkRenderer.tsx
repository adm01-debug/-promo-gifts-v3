      ...
      >
        {proxiedImage ? (
          <img
            src={proxiedImage}
            alt={name}
            className="h-10 w-10 rounded-2xl object-contain bg-muted/30 flex-shrink-0"
            loading="lazy"
            onError={() => setImgError(true)}
          />
        ) : (
          <div className="h-6 w-6 rounded-2xl bg-primary/8 flex items-center justify-center flex-shrink-0">
