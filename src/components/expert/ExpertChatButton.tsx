    ...
    return (
      <>
        <motion.button
          ...
          className="h-13 w-13 fixed bottom-20 right-4 z-40 flex items-center justify-center rounded-xl border border-primary/20 bg-gradient-to-br from-primary via-primary/80 to-primary/50 text-primary-foreground shadow-2xl backdrop-blur-sm sm:bottom-[6rem] sm:right-6 sm:h-14 sm:w-14"
