      ...
      {isOpen && (
        <>
          <motion.div
            ...
            className="absolute inset-0 z-20 rounded-xl bg-black/50 backdrop-blur-[3px]"
            onClick={onClose}
          />
          <motion.div
              ...
              <div className="flex items-center gap-1">
                {activeFiltersCount > 0 && (
                  <Button
                    ...
                    size="sm"
                    onClick={onReset}
                    className="h-6 gap-1 rounded-xl px-2 text-[9px] text-muted-foreground hover:text-destructive"
                  >
            ...
            <div className="px-3 pb-1 pt-2">
              <div className="relative">
                ...
                <input
                  ...
                  className="h-7 w-full rounded-xl border border-border/15 bg-muted/10 pl-7 pr-2 text-[11px] transition-all placeholder:text-muted-foreground/25 focus:outline-none focus:ring-1 focus:ring-primary/20"
                />
              </div>
            </div>
            {/* Sections */}
              ...
              <div className="pb-3">
                ...
                <div className="mt-4 border-t border-border/10 pt-3">
                  <div className="flex items-center justify-between px-1 py-1">
                    <div className="flex items-center gap-2.5">
                      <div className="flex h-6 w-6 items-center justify-center rounded-xl bg-muted/20">
