            ...
            {PRICE_PRESETS.map((p) => {
              ...
              return (
                <button key={p.label} onClick={() => handlePreset(p.min, p.max)}
                  className={cn("px-2.5 py-1 rounded-xl text-[10px] font-semibold border transition-all duration-150",
          ...
          <div className="flex items-center gap-2">
            <div className="flex-1 relative">
              ...
              <input type="number" min={0} step="0.01" value={filters.priceMin}
                ...
                placeholder="Mín"
                className={cn("w-full h-7 pl-6 pr-2 rounded-xl text-[11px] bg-background/30 border transition-all focus:outline-none focus:ring-1 focus:ring-primary/25",
