            ...
            {PRICE_PRESETS.map((p) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    'rounded-xl border px-2.5 py-1 text-[10px] font-semibold transition-all duration-150',
                    isActive
          ...
          <div className="flex items-center gap-2">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="Mín"
                className={cn(
                  'h-7 w-full rounded-xl border bg-background/30 pl-6 pr-2 text-[11px] transition-all focus:outline-none focus:ring-1 focus:ring-primary/25',
                  filters.priceMin
