                ...
                <div className="flex flex-col max-w-[80%] group/msg">
                  ...
                  {message.isError && !isLoading && (
                    <button onClick={onRetry}
                      className="flex items-center gap-1.5 self-start mt-1.5 ml-0.5 px-2.5 py-1 rounded-md text-[11px] font-medium text-destructive hover:bg-destructive/10 transition-colors">
                      ...
                      <div className={cn("flex items-center gap-1 self-start mt-1.5 ml-0.5 transition-opacity duration-150",
                        ...
                        {isActive && (
                          <button onClick={onStopTts}
                            className="p-1.5 rounded-md text-muted-foreground/50 hover:text-destructive hover:bg-destructive/10 transition-all duration-150"
          ...
          <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="flex flex-wrap gap-1.5 ml-9 mt-1">
            {[
              ...
              <button key={action.label} onClick={() => onAutoSend(action.prompt)}
                className="flex items-center gap-1 px-2.5 py-1 rounded-md text-[11px] font-medium border border-border/40 bg-background/80 hover:border-primary/30 hover:bg-primary/5 text-muted-foreground hover:text-foreground transition-all duration-150">
