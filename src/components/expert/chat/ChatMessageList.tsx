      ...
      <div className="space-y-3">
              ...
              >
                ...
                <div className="group/msg flex max-w-[80%] flex-col">
                  ...
                  {message.isError && !isLoading && (
                    <button
                      onClick={onRetry}
                      className="ml-0.5 mt-1.5 flex items-center gap-1.5 self-start rounded-xl px-2.5 py-1 text-[11px] font-medium text-destructive transition-colors hover:bg-destructive/10"
                    >
                      ...
                      return (
                        ...
                        >
                          ...
                          {isActive && (
                            <button
                              onClick={onStopTts}
                              className="rounded-xl p-1.5 text-muted-foreground/50 transition-all duration-150 hover:bg-destructive/10 hover:text-destructive"
                              title="Parar"
            ...
            >
              {[
                ...
                <button
                  ...
                  className="flex items-center gap-1 rounded-xl border border-border/40 bg-background/80 px-2.5 py-1 text-[11px] font-medium text-muted-foreground transition-all duration-150 hover:border-primary/30 hover:bg-primary/5 hover:text-foreground"
                >
        ...
        {isLoading && messages[messages.length - 1]?.role === 'user' && (
          ...
          >
            ...
            <div className="rounded-xl rounded-bl-lg border border-border/20 bg-muted/50 px-4 py-3">
