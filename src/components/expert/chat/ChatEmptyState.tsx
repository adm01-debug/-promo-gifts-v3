  ...
  return (
    <motion.div initial="hidden" animate="visible"
      ...
      <motion.div variants={{ hidden: { opacity: 0, scale: 0.8 }, visible: { opacity: 1, scale: 1 } }}
        ...
        <motion.div className="absolute -bottom-1.5 -right-1.5 h-6 w-6 rounded-2xl bg-background border border-border/50 flex items-center justify-center shadow-sm"
