...
function NotificationItem({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "group flex gap-3 p-3 rounded-2xl transition-all duration-200 cursor-pointer hover:bg-muted/50 hover:shadow-sm",
    ...
    >
      <div className={cn("mt-0.5 p-1.5 rounded-2xl shrink-0", config.bg)}>
