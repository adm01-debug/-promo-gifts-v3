...
function NotificationItem({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group flex cursor-pointer gap-3 rounded-xl p-3 transition-all duration-200 hover:bg-muted/50 hover:shadow-sm',
    ...
    >
      <div className={cn('mt-0.5 shrink-0 rounded-xl p-1.5', config.bg)}>
