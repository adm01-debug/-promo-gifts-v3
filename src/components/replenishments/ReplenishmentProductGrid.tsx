...
} from '@/hooks/useReplenishmentsSelectionMode';
        ...
        <div className="space-y-4" role="status" aria-label="Carregando produtos">
          ...
          <div className={`grid ${getGridColsClass(gridColumns)} ${getGridGapClass(gridColumns)}`}>
            {Array.from({ length: 10 }).map((_, i) => (
              <div
                key={i}
                className="animate-pulse overflow-hidden rounded-xl border border-border/30"
              >
    ...
    if (error && products.length === 0) {
      return (
        <div className="py-10 text-center" role="alert">
          <div className="mb-3 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-destructive/10">
    ...
    if (filteredProducts.length === 0) {
      return (
        <div className="py-10 text-center" role="status">
          <div className="mb-3 inline-flex h-14 w-14 items-center justify-center rounded-xl bg-muted/80">
