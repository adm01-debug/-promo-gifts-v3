    ...
    if (error && products.length === 0) {
      return (
        <div className="text-center py-10" role="alert">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-destructive/10 mb-3">
    ...
    if (filteredProducts.length === 0) {
      return (
        <div className="text-center py-10" role="status">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-lg bg-muted/80 mb-3">
