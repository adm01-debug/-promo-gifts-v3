    ...
    <>
      ...
      {showTrigger && (
        <button
          ...
          className="hidden md:flex items-center gap-2 px-3 py-2 text-sm text-muted-foreground bg-muted/50 hover:bg-muted rounded-md border border-border transition-all duration-200 hover:text-foreground"
        >
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        <Command className="rounded-md border-0 shadow-2xl">
