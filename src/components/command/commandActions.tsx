...
export function buildActions({ goTo, actualTheme, setTheme, setOpen }: BuildActionsParams): CommandAction[] {
  return [
    ...
    },
    {
      id: "stock",
      label: "Estoque 360º",
      description: "Monitorar estoque e reposição",
      icon: <Layers className="h-4 w-4" />,
      action: () => goTo("/estoque", "Estoque 360º"),
      keywords: ["estoque", "stock", "inventário", "alertas", "360"],
      category: "navigation",
      path: "/estoque",
    },
    {
      id: "trends",
      label: "Tendências",
      description: "Insights de mercado e produtos em alta",
      icon: <Zap className="h-4 w-4" />,
      action: () => goTo("/tendencias", "Tendências"),
      keywords: ["tendências", "trends", "mercado", "alta"],
      category: "navigation",
      path: "/tendencias",
    },
    {
      ...
      description: "Analytics estratégico de vendas e mercado",
      icon: <BarChart3 className="h-4 w-4" />,
      action: () => goTo("/ferramentas/bi-comercial", "Inteligência Comercial"),
      keywords: ["bi", "inteligência", "comercial", "analytics", "vendas"],
      category: "navigation",
