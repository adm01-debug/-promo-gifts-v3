  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <SkeletonShimmer className="h-8 w-8 rounded-2xl" />
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <SkeletonShimmer className="h-8 w-24 rounded-2xl" />
      </div>
...
export function ListItemSkeleton({ className }: { className?: string }) {
  return (
    ...
    >
      <SkeletonShimmer className="h-12 w-12 rounded-2xl flex-shrink-0" />
      <div className="flex-1 space-y-2">
        <SkeletonShimmer className="h-4 w-3/4" />
        <SkeletonShimmer className="h-3 w-1/2" />
      </div>
      <SkeletonShimmer className="h-8 w-8 rounded-2xl flex-shrink-0" />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex gap-3 pt-4">
        <SkeletonShimmer className="h-10 w-32 rounded-2xl" />
        <SkeletonShimmer className="h-10 w-24 rounded-2xl" />
      </div>
    </div>
  );
}
    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <SkeletonShimmer className="h-10 w-32 rounded-2xl" />
          <SkeletonShimmer className="h-10 w-10 rounded-2xl" />
        </div>
      </div>
    </div>
  );
