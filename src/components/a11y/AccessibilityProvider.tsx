...
export function SkipToContent() {
  return (
    <a
      href="#main-content"
      className="fixed left-0 top-0 z-[9999] m-3 -translate-y-full transform rounded-xl bg-primary px-4 py-2 font-semibold text-primary-foreground transition-transform focus:translate-y-0 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2"
    >
