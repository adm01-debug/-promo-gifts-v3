          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {components.map((comp, idx) => (
              <button
                ...
                className="p-4 rounded-md border bg-card hover:bg-accent hover:border-primary/50 transition-all text-left group"
              >
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {selectedComponent.locations.map((loc, idx) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-md bg-orange/10 flex items-center justify-center group-hover:bg-orange/20 transition-colors">
          ...
          <div className="grid gap-2">
            {selectedLocation.techniques.map((tech) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-md bg-success/10 flex items-center justify-center group-hover:bg-success/20 transition-colors">
