          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {components.map((comp, idx) => (
              <button
                ...
                className="group rounded-xl border bg-card p-4 text-left transition-all hover:border-primary/50 hover:bg-accent"
              >
          ...
          <div className="grid gap-2 sm:grid-cols-2">
            {selectedComponent.locations.map((loc, idx) => {
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-orange/10 transition-colors group-hover:bg-orange/20">
          ...
          <div className="grid gap-2">
            {selectedLocation.techniques.map((tech) => (
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-success/10 transition-colors group-hover:bg-success/20">
