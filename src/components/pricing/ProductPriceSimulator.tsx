      ...
      <CardContent className="space-y-6">
        ...
        {selectedProduct && (!hasVariants || selectedVariant) && (
          <div className="animate-fade-in space-y-3">
            ...
            {mode === 'adding' && (
              <div className="animate-scale-in space-y-4 rounded-xl border-2 border-dashed border-primary/30 bg-primary/5 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent className="border-none bg-primary px-2 py-1 text-[11px] font-medium text-primary-foreground shadow-xl">
                        Voltar para lista de gravações
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
                    ...
                    <div className="flex items-center gap-3 rounded-xl border bg-background p-3">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent className="border-none bg-primary px-2 py-1 text-[11px] font-medium text-primary-foreground shadow-xl">
                            Escolher outra técnica de gravação
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </div>
