      ...
      <CardContent className="space-y-6">
        ...
        {selectedProduct && (!hasVariants || selectedVariant) && (
          <div className="space-y-3 animate-fade-in">
            ...
            {mode === 'adding' && (
              <div className="space-y-4 p-4 rounded-2xl border-2 border-dashed border-primary/30 bg-primary/5 animate-scale-in">
                <div className="flex items-center justify-between">
                ...
                {currentTechnique && (
                  <div className="space-y-4 animate-fade-in">
                    <div className="p-3 rounded-2xl bg-background border flex items-center gap-3">
                      <Check className="w-5 h-5 text-success shrink-0" />
                      <div className="flex-1 min-w-0">
