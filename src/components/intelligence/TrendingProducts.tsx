        ...
        <div className="flex items-center justify-between">
          <div>
            <CardTitle className="text-base flex items-center gap-2">
              <div className="w-7 h-7 rounded-xl bg-gradient-to-br from-orange to-warning flex items-center justify-center">
          ...
          <div className="divide-y divide-border">
            {products!.map((product, index) => (
              ...
              >
                ...
                {/* Image */}
                <div className="w-9 h-9 rounded-xl overflow-hidden bg-muted border border-border/50 shrink-0">
