      ...
      <Card className="border-primary/30 bg-gradient-to-br from-primary/5 via-background to-chart-2/5 animate-fade-in">
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/40 border border-dashed border-border">
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid gap-2.5">
                ...
                {data.highlights && data.highlights.length > 0 && (
                  <div
                    className="flex items-start gap-2 p-2.5 rounded-lg bg-card/60 border border-border/40 animate-fade-in"
