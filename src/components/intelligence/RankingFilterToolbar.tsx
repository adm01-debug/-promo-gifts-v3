          ...
          >
            ...
            <div className="p-1">
              {searchHistory.map((item) => (
                ...
                >
                  <button
                    className="flex-1 flex items-center gap-3 px-3 py-2 text-sm text-left hover:bg-accent rounded-lg transition-colors truncate"
                    onClick={() => {
