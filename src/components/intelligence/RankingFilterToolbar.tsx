  ...
  return (
    <div className="flex flex-col gap-2">
          ...
          >
            ...
            <div className="p-1">
              {searchHistory.map((item) => (
                ...
                >
                  <button
                    className="flex-1 flex items-center gap-3 px-3 py-2 text-sm text-left hover:bg-accent rounded-xl transition-colors truncate"
                    onClick={() => {
      ...
      <div className="flex flex-wrap items-center gap-2">
        {/* Period */}
        <div className="flex items-center gap-0.5 bg-muted/50 rounded-xl p-0.5 border border-border/50">
