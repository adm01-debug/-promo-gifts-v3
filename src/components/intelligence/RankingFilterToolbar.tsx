  ...
  return (
    <div className="flex flex-col gap-2">
            ...
            <div className="p-1">
              {searchHistory.map((item) => (
                <div key={item.id} className="group/item flex items-center">
                  <button
                    className="flex flex-1 items-center gap-3 truncate rounded-xl px-3 py-2 text-left text-sm transition-colors hover:bg-accent"
                    onClick={() => {
      ...
      <div className="flex flex-wrap items-center gap-2">
        {/* Period */}
        <div className="flex items-center gap-0.5 rounded-xl border border-border/50 bg-muted/50 p-0.5">
