    ...
    if (isCollapsed) {
      return (
        <div ref={ref} className="flex flex-col items-center justify-center gap-4 py-4 mb-2">
          <div className="w-8 h-8 rounded-lg bg-[#3B82F6] flex items-center justify-center shadow-lg shadow-primary/20">
    ...
    return (
      <div ref={ref} className="px-4 py-3 mb-2">
        <div className="flex items-center gap-2.5 min-w-0">
          <div className="w-9 h-9 rounded-lg bg-[#3B82F6] flex items-center justify-center shrink-0 shadow-lg shadow-primary/20">
