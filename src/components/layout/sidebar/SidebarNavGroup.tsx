        ...
        <div key={item.label}>
          <button
            ...
            className={cn(
              ...
              hasActiveChild
                ? "text-orange font-semibold bg-orange/15"
    ...
    const linkContent = (
      <NavLink
        ...
        className={cn(
          ...
          isActive
            ? "bg-orange/[0.06] text-orange font-bold before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:h-5 before:w-[2px] before:rounded-r-full before:bg-orange"
