  ...
  const renderNavLink = (item: NavItem, depth = 0): React.ReactNode => {
      ...
      return (
        <div key={item.label}>
          <button
            ...
            className={cn(
              "flex items-center gap-3 w-full px-3 py-2 rounded-md transition-all duration-150 group relative",
    ...
    const linkContent = (
      <NavLink
        ...
        className={cn(
          "flex items-center gap-3 px-3 py-2 rounded-md transition-all duration-150 group relative focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-orange/20 active:scale-[0.995]",
    ...
    <Collapsible open={isOpen} onOpenChange={onToggle}>
      <CollapsibleTrigger asChild>
        <button
          ...
          className={cn(
            "flex items-center gap-3 w-full px-3 py-2 rounded-md transition-all duration-150 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-orange/15 active:scale-[0.995]",
