  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-4">
        ...
        <div
          className={cn(
            "flex h-12 w-12 shrink-0 items-center justify-center rounded-md transition-all duration-300",
            styles.bg,
            styles.glow
          )}
        >
...
export function MiniStatCard({
  ...
  return (
    <div
      className={cn(
        "flex items-center gap-3 rounded-md border border-border bg-card p-3 transition-all duration-200",
