          ...
          {mainNavItems.map((item, index) => {
            ...
            return (
              <NavLink
                ...
                to={item.href}
                className={cn(
                  "relative flex flex-col items-center justify-center min-w-[56px] sm:min-w-[64px] min-h-[44px] sm:min-h-[48px] px-2 sm:px-3 py-1.5 sm:py-2 rounded-2xl transition-all",
