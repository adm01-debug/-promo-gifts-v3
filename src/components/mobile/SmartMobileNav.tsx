          ...
          {mainNavItems.map((item, index) => {
            ...
            return (
              <NavLink
                ...
                to={item.href}
                className={cn(
                  'relative flex min-h-[44px] min-w-[56px] flex-col items-center justify-center rounded-xl px-2 py-1.5 transition-all sm:min-h-[48px] sm:min-w-[64px] sm:px-3 sm:py-2',
