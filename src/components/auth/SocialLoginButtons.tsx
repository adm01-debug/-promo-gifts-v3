...
export const SocialLoginButtons = forwardRef<HTMLDivElement, SocialLoginButtonsProps>(
  function SocialLoginButtons({ onError }, ref) {
    ...
    const handleGoogleLogin = async () => {
      ...
      authDebug('social-login', 'google click', {
        redirect_uri,
    ...
    return (
      <div ref={ref} className="space-y-3">
        <Button
          type="button"
          variant="outline"
          className="h-12 w-full gap-3 border-border/60 bg-background font-bold uppercase tracking-widest shadow-sm transition-all hover:bg-muted/50"
