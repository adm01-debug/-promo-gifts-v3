...
function TreeNode({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "flex items-center gap-2 py-2.5 px-3 rounded-2xl cursor-pointer transition-all duration-200",
          "hover:bg-accent/60",
            ...
            <div className="px-2">
              ...
              {searchResults.map(cat => (
                <div
                  key={cat.id}
                  className={cn(
                    "flex items-center gap-2 py-2 px-3 rounded-2xl cursor-pointer",
