...
export function ProductCard({ 
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[4/5] overflow-hidden bg-white dark:bg-card" style={{ zIndex: 0 }}>
          ...
          return (
            <>
              <img
                ...
                className={cn(
                  "w-[80%] h-[80%] object-contain transition-all duration-700 ease-out mx-auto my-auto absolute inset-0 m-auto",
