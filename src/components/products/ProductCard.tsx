  ...
  forwardRef<HTMLElement, ProductCardProps>(function ProductCard(
    ...
    return (
      <article
        ...
        className={cn(
          'group relative cursor-pointer overflow-hidden rounded-xl bg-card sm:rounded-xl',
          'touch-manipulation transition-all duration-500 ease-in-out active:scale-[0.98] active:transition-transform active:duration-100',
          'hover:-translate-y-2 hover:shadow-premium',
          product.featured && 'shadow-lg ring-2 ring-primary/20',
          hasHighlightedColor
            ? 'border-2'
            : 'border-[1.5px] border-primary/10 hover:border-primary/50',
        )}
        style={
      ...
      >
        ...
        >
          ...
          <h3
            ...
            className="line-clamp-2 min-h-[2.25rem] font-display text-sm font-semibold leading-snug text-foreground transition-colors duration-300 group-hover:text-primary sm:min-h-[2.75rem] sm:text-base"
          >
            {product.name}
          </h3>
