            ...
            >
              {variant.selected_thumbnail ? (
                <img
                  ...
                  className="w-8 h-8 rounded-lg object-cover border border-border/50 shrink-0 group-hover:scale-105 transition-transform"
                  onError={(e) => {
                ...
                <div
                  className="w-8 h-8 rounded-lg border border-border/50 shrink-0 group-hover:scale-105 transition-transform"
