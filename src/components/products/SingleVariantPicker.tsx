  ...
  return (
    <div className={cn('space-y-2', className)}>
      ...
      <button
        ...
        className="w-full flex items-center gap-2 p-2 rounded-2xl border border-dashed border-border/60 hover:border-primary/40 hover:bg-primary/5 transition-all text-left text-xs text-muted-foreground group"
      >
        ...
        {sortedVariants.map((variant) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex items-center gap-2 p-2 rounded-2xl border transition-all text-left group',
            ...
            >
              {variant.selected_thumbnail ? (
                <img
                  ...
                  className="w-8 h-8 rounded-2xl object-cover border border-border/50 shrink-0 group-hover:scale-105 transition-transform"
                  onError={(e) => {
                ...
                <div
                  className="w-8 h-8 rounded-2xl border border-border/50 shrink-0 group-hover:scale-105 transition-transform"
