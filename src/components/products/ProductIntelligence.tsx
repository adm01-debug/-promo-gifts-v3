          ...
          <CardContent className="p-3">
            ...
            <div className="flex gap-2 overflow-x-auto pb-1">
              {frequentlyBoughtTogether.data.map((product) => (
                ...
                >
                  <div className="w-16 h-16 rounded-2xl overflow-hidden bg-muted border border-border/50 group-hover:border-primary/30 transition-colors">
  ...
  return (
    <Card>
      <CardContent className="p-2.5">
        <div className={cn("w-7 h-7 rounded-2xl flex items-center justify-center mb-1.5", bgColor[color])}>
...
function ProductIntelligenceSkeleton() {
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        <Skeleton className="w-7 h-7 rounded-2xl" />
        <div>
