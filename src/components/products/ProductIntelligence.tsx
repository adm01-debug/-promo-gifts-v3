import { Eye, Users, BarChart3, Package, Target, Zap } from 'lucide-react';
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        <div className="skin-icon flex h-7 w-7 items-center justify-center rounded-xl">
          ...
          <CardContent className="p-3">
            ...
            <div className="flex gap-2 overflow-x-auto pb-1">
              {frequentlyBoughtTogether.data.map((product) => (
                ...
                >
                  <div className="h-16 w-16 overflow-hidden rounded-xl border border-border/50 bg-muted transition-colors group-hover:border-primary/30">
  ...
  return (
    <Card>
      <CardContent className="p-2.5">
        <div
          className={cn(
            'mb-1.5 flex h-7 w-7 items-center justify-center rounded-xl',
            bgColor[color],
          )}
        >
