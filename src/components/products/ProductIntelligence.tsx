          ...
          <CardContent className="p-3">
            ...
            <div className="flex gap-2 overflow-x-auto pb-1">
              {frequentlyBoughtTogether.data.map((product) => (
                ...
                >
                  <div className="w-16 h-16 rounded-md overflow-hidden bg-muted border border-border/50 group-hover:border-primary/30 transition-colors">
  ...
  return (
    <Card>
      <CardContent className="p-2.5">
        <div className={cn("w-7 h-7 rounded-md flex items-center justify-center mb-1.5", bgColor[color])}>
