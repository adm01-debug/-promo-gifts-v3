  ...
  if (selection?.companyId && selectedCompany) {
    return (
      <div className="space-y-2">
        {/* Company badge */}
        <div className="flex items-center gap-2 p-2 rounded-2xl bg-secondary/50 border border-border">
              ...
              {contacts.map((contact) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      "w-full flex items-center gap-2 p-2 rounded-2xl text-left text-sm transition-colors",
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {showDropdown && debouncedSearch.length >= 2 && (
        <div className="absolute z-50 w-full mt-1 rounded-2xl border bg-popover shadow-md">
          {loadingCompanies ? (
