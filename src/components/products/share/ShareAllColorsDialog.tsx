                    ...
                    {items.map(({ color, index }) => {
                      ...
                      return (
                        <button
                          ...
                          className={cn(
                            "flex items-center gap-2 p-1.5 rounded-2xl text-left transition-all border",
                            isSelected
                        ...
                        >
                          {/* Color thumbnail */}
                          <div className="relative w-10 h-10 rounded-2xl overflow-hidden bg-secondary shrink-0">
                            <img
                              src={thumb}
                              alt={color.name}
