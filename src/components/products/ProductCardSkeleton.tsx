...
export function ProductCardInlineSkeleton() {
  return (
    <div className="relative flex items-center gap-3 overflow-hidden rounded-xl border border-border/40 bg-card p-3">
      <div className="bg-shimmer pointer-events-none absolute inset-0 animate-shimmer" />
      <Skeleton className="h-16 w-16 shrink-0 rounded-xl bg-muted/40" />
