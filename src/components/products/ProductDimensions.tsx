...
function SpecItem({ icon, label, value, unit, iconBgClass = "bg-primary/10", iconColorClass = "text-primary", compact }: SpecItemProps) {
  if (compact) {
    return (
      <div className="flex items-center gap-2.5 px-3 py-3 rounded-lg bg-secondary/40 border border-border/40">
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-1.5 p-4 rounded-lg bg-secondary/50 border border-border text-center">
