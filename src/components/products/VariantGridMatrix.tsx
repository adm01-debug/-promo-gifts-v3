            ...
            return (
              <Tooltip key={variant.id}><TooltipTrigger asChild>
                <button 
                  ...
                  className={cn(
                    "flex items-center gap-2 px-3 py-2 rounded-2xl border-2 transition-all text-sm",
                      ...
                      <td key={size} className={cn("text-center border-border", compact ? "px-1 py-1" : "px-2 py-2")}>
                        <Tooltip><TooltipTrigger asChild>
                          <button 
                            onClick={() => isAdmin ? toggleSelection(variant.id) : onSelect?.(variant)} 
                            className={cn(
                              "w-full min-w-[3rem] py-1.5 px-2 rounded-2xl transition-all text-xs font-medium",
