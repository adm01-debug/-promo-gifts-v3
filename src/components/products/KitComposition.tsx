          ...
          <div className="flex items-center gap-2">
            <div className="hidden -space-x-2 sm:flex">
              {items.slice(0, 4).map((item) => (
                <div
                  key={item.id}
                  className="flex h-8 w-8 items-center justify-center overflow-hidden rounded-xl border-2 border-card bg-muted"
                >
                  {item.imageUrl ? (
                    <img
                      src={item.imageUrl}
              ...
              {items.length > 4 && (
                <div className="flex h-8 w-8 items-center justify-center rounded-xl border-2 border-card bg-muted text-[10px] font-bold text-muted-foreground">
                  +{items.length - 4}
                </div>
              )}
            </div>
          ...
          <ScrollArea className="max-h-[calc(72vh-160px)]">
            <div className="space-y-5 px-6 py-4">
              {packagingItems.length > 0 && (
                ...
                >
                  <CollapsibleTrigger className="flex w-full items-center justify-between rounded-xl border border-warning/20 bg-warning/5 px-3 py-2.5 transition-colors hover:bg-warning/10">
              ...
              {productItems.length > 0 && (
                ...
                >
                  <CollapsibleTrigger className="flex w-full items-center justify-between rounded-xl border border-border/50 bg-muted/30 px-3 py-2.5 transition-colors hover:bg-muted/50">
