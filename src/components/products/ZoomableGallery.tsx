    ...
    ({ fullscreen = false }: { fullscreen?: boolean }) => (
      <motion.div
        ...
        className={cn(
          ...
          fullscreen ? 'h-full w-full' : 'aspect-square rounded-xl',
        )}
    ...
    <>
      <div className={cn('space-y-4', className)}>
        <div className="group relative">
          <div className="overflow-hidden rounded-xl border border-border/50 shadow-lg transition-shadow group-hover:shadow-xl">
            <ImageViewer />
          </div>
          {images.length > 1 && (
            <>
