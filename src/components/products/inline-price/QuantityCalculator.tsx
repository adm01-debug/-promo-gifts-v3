      ...
      <div className="space-y-3 pt-1">
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-1 flex-[1.5]">
            ...
            <div className="h-11 px-3 rounded-md bg-success/10 border border-success/20 flex items-center gap-2">
    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex-1 space-y-2">
          ...
          <div className="h-12 px-4 rounded-md bg-success/10 border border-success/20 flex items-center justify-between">
            <div>
