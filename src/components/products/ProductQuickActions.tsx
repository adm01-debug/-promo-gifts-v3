              ...
              <Tooltip key={key}>
                <TooltipTrigger asChild>
                  <button
                    ...
                    className={cn(
                      "group relative inline-flex items-center justify-center gap-2 flex-1 px-4 py-3 rounded-2xl text-xs font-bold border overflow-hidden",
                ...
                <div key={category} className="space-y-2.5">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {items.map((item) => (
                      <span
                        key={item}
                        className="px-3 py-1.5 rounded-2xl text-xs font-medium bg-muted text-foreground border border-border/40"
                      >
                        {item}
                      </span>
                    ))}
