...
export function BulkToolbar({
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-xl border border-primary/20 bg-primary/5 px-3 py-2 duration-200 animate-in slide-in-from-top-2">
