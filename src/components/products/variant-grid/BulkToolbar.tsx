...
export function BulkToolbar({ selectedCount, totalCount, onSelectAll, onDeselectAll, onToggleActive, onUpdateStock, isLoading }: BulkToolbarProps) {
  ...
  return (
    <div className="flex items-center gap-2 flex-wrap bg-primary/5 border border-primary/20 rounded-xl px-3 py-2 animate-in slide-in-from-top-2 duration-200">
