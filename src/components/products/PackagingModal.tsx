      ...
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2 text-lg">
            <div className="w-8 h-8 rounded-2xl bg-warning/10 flex items-center justify-center">
        ...
        <div className="space-y-5 pt-2">
          ...
          {/* Observação */}
          <Separator className="bg-border/50" />
          <div className="flex items-start gap-2 p-3 rounded-2xl bg-info/5 border border-info/20">
