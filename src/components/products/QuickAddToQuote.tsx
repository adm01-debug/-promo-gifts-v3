  ...
  return (
    <Popover open={isOpen} onOpenChange={handleOpenChange}>
      ...
      >
        <button
          aria-label="Fechar"
          className="absolute right-2 top-2 z-10 flex h-6 w-6 items-center justify-center rounded-xl text-muted-foreground transition-colors hover:bg-muted/60 hover:text-foreground"
              ...
              <div className="flex items-center gap-2 rounded-xl border border-border/50 bg-muted/40 p-2">
                {selectedVariant.selected_thumbnail ? (
                  <img
                    ...
                    className="h-7 w-7 rounded-xl border border-border/50 object-cover"
                  />
                ) : selectedVariant.color_hex ? (
                  <div
                    className="h-7 w-7 rounded-xl border border-border/50"
