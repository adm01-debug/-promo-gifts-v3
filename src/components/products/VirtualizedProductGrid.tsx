...
export function VirtualizedProductGrid({
  ...
  return (
    <div className="relative h-full">
      <div
        ref={parentRef}
        className="scrollbar-products h-[calc(100vh-200px)] min-h-[600px] overflow-y-auto overscroll-contain rounded-xl border border-primary/10 bg-gradient-to-b from-background via-background/95 to-background/90 shadow-sm backdrop-blur-sm"
      ...
      >
        ...
        {showFilterBar && onSortChange && onOpenFilters && onClearFilters && onViewModeChange && (
          <div className="sticky top-0 z-20 mb-2 border-b border-primary/10 bg-background/95 px-4 py-2.5 shadow-sm backdrop-blur-md">
            <InlineFilterBar
