    ...
    >
      ...
      {hasSpecs && (
        <div className="px-4 pb-2.5">
          <div className="flex items-center gap-1 divide-x divide-border rounded-xl border border-border bg-muted/20 px-1 py-0.5">
            {(item.heightMm ?? 0) > 0 && (
        ...
        <div className="space-y-3 border-t border-border/50 px-4 pb-4 duration-200 animate-in slide-in-from-top-1">
          {item.description && (
            <div className="pt-3">
              ...
              <p className="whitespace-pre-line rounded-xl bg-muted/20 p-3 text-xs leading-relaxed text-muted-foreground/90">
                {item.description}
              </p>
            </div>
          )}
