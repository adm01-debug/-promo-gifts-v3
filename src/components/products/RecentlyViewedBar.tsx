          ...
          <div className="scrollbar-none flex flex-1 items-center gap-2 overflow-x-auto">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={cn(
                        'h-10 w-10 overflow-hidden rounded-xl border-2 border-border/50',
                  ...
                  <TooltipContent
                    side="bottom"
                    className="max-w-[200px] border-none bg-primary px-2 py-1 text-[11px] text-primary-foreground"
                  >
            ...
            {itemCount > maxVisible && (
              <button
                ...
                className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl border-2 border-dashed border-border/50 transition-colors hover:border-primary/50"
              >
