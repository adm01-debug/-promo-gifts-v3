          ...
          <div className="flex items-center gap-2 flex-1 overflow-x-auto scrollbar-none">
                ...
                <Tooltip>
                  <TooltipTrigger asChild>
                    <button
                      ...
                      className={cn(
                        "w-10 h-10 rounded-md overflow-hidden border-2 border-border/50",
            ...
            {itemCount > maxVisible && (
              <button
                ...
                className="w-10 h-10 rounded-md border-2 border-dashed border-border/50 flex items-center justify-center flex-shrink-0 hover:border-primary/50 transition-colors"
              >
