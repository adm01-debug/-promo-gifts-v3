        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-2 gap-3 md:grid-cols-3 lg:grid-cols-5">
            {data.map((b) => (
              <div
                key={b.product_id}
                className="rounded-xl border bg-card p-3 transition-all hover:border-primary/30 hover:shadow-sm"
              >
                {b.product_image_url ? (
                  <div className="mb-2 aspect-square overflow-hidden rounded-xl border bg-muted/40">
                    <img
                  ...
                  <div className="mb-2 flex aspect-square items-center justify-center rounded-xl bg-muted/40">
