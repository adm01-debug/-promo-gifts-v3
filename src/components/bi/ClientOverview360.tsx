...
function DeltaPill({ pct }: { pct: number }) {
  ...
  return (
    <span className={cn("inline-flex items-center gap-0.5 rounded-lg px-1.5 py-0.5 text-[10px] font-bold", cls)}>
    ...
    <div className="space-y-3">
      <div className="flex items-center justify-between gap-3 flex-wrap">
        ...
        <label className="flex items-center gap-2 cursor-pointer text-xs">
          <Switch checked={comparePeriod} onCheckedChange={setComparePeriod} aria-label="Comparar período" />
