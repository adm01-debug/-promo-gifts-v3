    ...
    <Card className="border-[1.5px]">
      ...
      <CardContent className="space-y-4">
                ...
                {seasonality.client.map((c) => (
                  <Tooltip key={`c-${c.month}`}>
                    <TooltipTrigger asChild>
                      <div
                        className={cn(
                          'flex h-12 cursor-help items-center justify-center rounded-xl text-xs font-bold transition-all hover:scale-110',
                ...
                {seasonality.industry.map((c) => (
                  <Tooltip key={`i-${c.month}`}>
                    <TooltipTrigger asChild>
                      <div
                        className={cn(
                          'flex h-12 cursor-help items-center justify-center rounded-xl text-xs font-bold opacity-90 transition-all hover:scale-110',
                          intensityToBg(c.intensity),
                          intensityToText(c.intensity),
                          c.month === currentMonth &&
        ...
        <div className="grid grid-cols-1 gap-3 pt-1 md:grid-cols-2">
          <div className="rounded-xl border border-violet-200 bg-violet-50/50 p-3 dark:border-violet-800/50 dark:bg-violet-950/30">
          ...
          <div className="flex flex-col rounded-xl border border-success/40 bg-success/5 p-3">
            <div className="mb-1.5 flex items-center gap-2">
            ...
            {nextPeakName && seasonality.daysToNextPeak !== null ? (
              <>
                <div className="text-xl font-bold text-foreground">Campanha em {nextPeakName}</div>
