                ...
                {seasonality.client.map((c) => (
                  <Tooltip key={`c-${c.month}`}>
                    <TooltipTrigger asChild>
                      <div
                        className={cn(
                          "h-12 rounded-lg flex items-center justify-center text-xs font-bold transition-all hover:scale-110 cursor-help",
                ...
                {seasonality.industry.map((c) => (
                  <Tooltip key={`i-${c.month}`}>
                    <TooltipTrigger asChild>
                      <div
                        className={cn(
                          "h-12 rounded-lg flex items-center justify-center text-xs font-bold transition-all hover:scale-110 cursor-help opacity-90",
                          intensityToBg(c.intensity),
                          intensityToText(c.intensity),
