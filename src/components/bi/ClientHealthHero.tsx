          ...
          <div className="flex flex-col lg:flex-row gap-5 lg:gap-6 items-start">
            ...
            <div className="flex-1 min-w-0 space-y-3">
              ...
              {(favoriteCategory || opportunityCategory) && (
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {favoriteCategory && (
                    <div className="flex items-center gap-2 p-2.5 rounded-2xl bg-emerald-500/10 border border-emerald-500/20">
                  ...
                  {opportunityCategory && (
                    <div className="flex items-center gap-2 p-2.5 rounded-2xl bg-violet-500/10 border border-violet-500/20">
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-start gap-2 p-2.5 rounded-2xl bg-background/60 border cursor-help">
              ...
              <details className="group">
                ...
                <div className="mt-3 grid grid-cols-2 sm:grid-cols-5 gap-2">
                  {breakdownEntries.map((b) => (
                    <div
                      key={b.label}
                      className="p-2 rounded-2xl bg-background/60 border space-y-1"
                    >
            ...
            <div className="flex flex-col gap-2 lg:w-56 shrink-0 w-full">
              ...
              {health.shareOfWalletPct > 0 && (
                <div className="rounded-2xl border bg-background/60 p-2.5 mt-1">
