        ...
        <CardContent className="p-5 sm:p-6">
          <div className="flex flex-col lg:flex-row gap-5 lg:gap-6 items-start">
            ...
            <div className="flex items-center gap-4 lg:flex-col lg:items-center lg:gap-2 shrink-0">
              <div
                className={cn(
                  "relative h-28 w-28 rounded-xl flex flex-col items-center justify-center",
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex items-start gap-2 p-2.5 rounded-xl bg-background/60 border cursor-help">
              ...
              <details className="group">
                ...
                <div className="mt-3 grid grid-cols-2 sm:grid-cols-5 gap-2">
                  {breakdownEntries.map((b) => (
                    <div
                      key={b.label}
                      className="p-2 rounded-xl bg-background/60 border space-y-1"
                    >
            ...
            <div className="flex flex-col gap-2 lg:w-56 shrink-0 w-full">
              ...
              {health.shareOfWalletPct > 0 && (
                <div className="rounded-xl border bg-background/60 p-2.5 mt-1">
