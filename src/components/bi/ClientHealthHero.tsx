        ...
        <CardContent className="p-5 sm:p-6">
          <div className="flex flex-col items-start gap-5 lg:flex-row lg:gap-6">
            ...
            <div className="flex shrink-0 items-center gap-4 lg:flex-col lg:items-center lg:gap-2">
              <div
                className={cn(
                  'relative flex h-28 w-28 flex-col items-center justify-center rounded-xl',
            ...
            <div className="min-w-0 flex-1 space-y-3">
              ...
              {(favoriteCategory || opportunityCategory) && (
                <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                  ...
                  {opportunityCategory && (
                    <div className="flex items-center gap-2 rounded-xl border border-violet-500/20 bg-violet-500/10 p-2.5">
                ...
                <TooltipProvider>
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <div className="flex cursor-help items-start gap-2 rounded-xl border bg-background/60 p-2.5">
              ...
              <details className="group">
                ...
                <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-5">
                  {breakdownEntries.map((b) => (
                    <div key={b.label} className="space-y-1 rounded-xl border bg-background/60 p-2">
            ...
            <div className="flex w-full shrink-0 flex-col gap-2 lg:w-56">
              ...
              {health.shareOfWalletPct > 0 && (
                <div className="mt-1 rounded-xl border bg-background/60 p-2.5">
