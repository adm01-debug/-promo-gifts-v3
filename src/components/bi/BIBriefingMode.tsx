          ...
          <div className="p-5 space-y-5">
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  {categoryHighlights.favorites.map((f, i) => (
                    <div
                      key={`fav-${i}`}
                      className="flex items-center justify-between gap-2 p-2.5 rounded-2xl border bg-emerald-500/5 border-emerald-500/20"
                    >
                  ...
                  {categoryHighlights.gap && (
                    <div className="flex items-center justify-between gap-2 p-2.5 rounded-2xl border bg-violet-500/5 border-violet-500/20">
                      <div className="flex items-center gap-2 min-w-0">
            ...
            <div className="space-y-2">
              ...
              {talkingPoints.map((tp, i) => {
                const Icon = tp.icon;
                return (
                  <div key={i} className="flex items-start gap-3 p-3 rounded-2xl border bg-card">
            ...
            <div className="space-y-2">
              ...
              <div className="rounded-2xl border-l-4 border-primary bg-primary/5 p-3">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1.5">
                {products.map((p, i) => (
                  <div key={i} className="flex items-center gap-3 p-2 rounded-2xl border bg-card">
                    <div className="h-6 w-6 rounded-2xl bg-muted flex items-center justify-center text-[10px] font-bold text-muted-foreground shrink-0">
                      {i + 1}
                    </div>
                    {p.image ? (
                      <div className="h-9 w-9 rounded-2xl overflow-hidden bg-muted border shrink-0">
                        <img
                          src={p.image}
                          alt={p.name}
                          loading="lazy"
