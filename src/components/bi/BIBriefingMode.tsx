              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  {categoryHighlights.favorites.map((f, i) => (
                    <div
                      key={`fav-${i}`}
                      className="flex items-center justify-between gap-2 p-2.5 rounded-md border bg-emerald-500/5 border-emerald-500/20"
                    >
                  ...
                  {categoryHighlights.gap && (
                    <div className="flex items-center justify-between gap-2 p-2.5 rounded-md border bg-violet-500/5 border-violet-500/20">
                      <div className="flex items-center gap-2 min-w-0">
