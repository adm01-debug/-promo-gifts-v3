      ...
      <SheetContent side="right" className="w-full sm:max-w-md p-0 flex flex-col">
        ...
        <ScrollArea className="flex-1">
          <div className="p-5 space-y-5">
            {/* Score hero */}
            <div className={cn("rounded-lg p-4 flex items-center gap-4", tierStyles.bg)}>
              <div className="h-20 w-20 rounded-lg bg-background/80 border-[1.5px] flex flex-col items-center justify-center shadow-sm shrink-0">
              ...
              <div className="space-y-1.5">
                {products.map((p, i) => (
                  <div key={i} className="flex items-center gap-3 p-2 rounded-lg border bg-card">
                    <div className="h-6 w-6 rounded-lg bg-muted flex items-center justify-center text-[10px] font-bold text-muted-foreground shrink-0">
                      {i + 1}
                    </div>
                    {p.image ? (
                      <div className="h-9 w-9 rounded-lg overflow-hidden bg-muted border shrink-0">
                        <img
                          src={p.image}
                          alt={p.name}
                          loading="lazy"
