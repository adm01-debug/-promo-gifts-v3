      ...
      <SheetContent side="right" className="flex w-full flex-col p-0 sm:max-w-md">
        ...
        <ScrollArea className="flex-1">
          <div className="space-y-5 p-5">
            {/* Score hero */}
            <div className={cn('flex items-center gap-4 rounded-xl p-4', tierStyles.bg)}>
              <div className="flex h-20 w-20 shrink-0 flex-col items-center justify-center rounded-xl border-[1.5px] bg-background/80 shadow-sm">
                <span
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-1.5">
                  {categoryHighlights.favorites.map((f, i) => (
                    <div
                      key={`fav-${i}`}
                      className="flex items-center justify-between gap-2 rounded-xl border border-emerald-500/20 bg-emerald-500/5 p-2.5"
                    >
                  ...
                  {categoryHighlights.gap && (
                    <div className="flex items-center justify-between gap-2 rounded-xl border border-violet-500/20 bg-violet-500/5 p-2.5">
                      <div className="flex min-w-0 items-center gap-2">
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-1.5">
                {products.map((p, i) => (
                  <div key={i} className="flex items-center gap-3 rounded-xl border bg-card p-2">
                    <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-xl bg-muted text-[10px] font-bold text-muted-foreground">
                      {i + 1}
                    </div>
                    {p.image ? (
                      <div className="h-9 w-9 shrink-0 overflow-hidden rounded-xl border bg-muted">
                        <img
                          src={p.image}
                          alt={p.name}
                          loading="lazy"
