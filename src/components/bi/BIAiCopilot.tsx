          ...
          <div className="space-y-3 p-4">
                ...
                <div className="space-y-1.5">
                  ...
                  {SUGGESTED_QUESTIONS.map((q) => (
                    <button
                      ...
                      className="w-full rounded-xl border bg-card p-2.5 text-left text-xs transition-colors hover:border-primary/30 hover:bg-muted/60"
                    >
                      {q}
                    </button>
                  ))}
            ...
            {loading && (
              <div className="flex gap-2">
                ...
                <div className="max-w-[80%] space-y-1.5 rounded-xl rounded-bl-sm bg-muted px-3 py-2">
