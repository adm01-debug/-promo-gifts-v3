      ...
      <SheetContent side="right" className="w-full sm:max-w-md p-0 flex flex-col">
        <SheetHeader className="p-5 pb-3 border-b bg-gradient-to-r from-violet-500/10 to-fuchsia-500/10">
          <SheetTitle className="flex items-center gap-2 font-display">
            <div className="h-8 w-8 rounded-md bg-gradient-to-br from-violet-600 to-fuchsia-600 flex items-center justify-center">
                ...
                <div className="space-y-1.5">
                  ...
                  {SUGGESTED_QUESTIONS.map((q) => (
                    <button
                      ...
                      className="w-full text-left text-xs p-2.5 rounded-md border bg-card hover:bg-muted/60 hover:border-primary/30 transition-colors"
                    >
                      {q}
                    </button>
                  ))}
