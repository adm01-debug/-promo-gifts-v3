        ...
        {(data ?? []).map(({ template, ratio, overlap }) => {
          ...
          return (
            <button
              ...
              className="w-full text-left rounded-2xl border p-2 hover:bg-accent/50 transition-colors flex items-center gap-2"
            >
              <div
                className="h-8 w-8 rounded-2xl flex items-center justify-center shrink-0"
