...
import { Package, Gift, Palette, FileText, Download, ShoppingCart, Printer, Check, Loader2, Image, AlertTriangle, TrendingUp, Scale, MessageCircle } from 'lucide-react';
...
export function KitSummary({
  ...
  // markupPercent state moved to KitMarginSimulator
