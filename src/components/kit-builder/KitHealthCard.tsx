    ...
    <Card className={className}>
      <CardContent className="p-4 space-y-3">
        ...
        {sortedHist.length >= 5 && (
          <div className="space-y-2 pt-2 border-t">
            ...
            {inRange && totalPrice > 0 && (
              <div className="flex items-start gap-2 rounded-2xl bg-success/10 p-2 text-xs text-success">
                <CheckCircle2 className="h-3.5 w-3.5 shrink-0 mt-0.5" />
                <span>Preço dentro do range competitivo do mercado.</span>
              </div>
            )}
            {aboveRange && (
              <div className="flex items-start gap-2 rounded-2xl bg-warning/10 p-2 text-xs text-warning-foreground">
            ...
            {belowRange && (
              <div className="flex items-start gap-2 rounded-2xl bg-destructive/10 p-2 text-xs text-destructive">
        ...
        {sortedHist.length < 5 && totalPrice > 0 && (
          <div className="flex items-start gap-2 rounded-2xl bg-muted/40 p-2 text-xs text-muted-foreground">
