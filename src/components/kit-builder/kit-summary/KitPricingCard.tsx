        ...
        <CardContent>
          <div className="grid grid-cols-5 gap-2 text-center">
            {[50, 100, 200, 500, 1000].map(qty => {
              ...
              return (
                <button key={qty} onClick={() => onKitQuantityChange(qty)} className={cn("rounded-md p-2.5 border transition-all cursor-pointer", isCurrentQty ? "border-primary bg-primary/10 ring-1 ring-primary" : "border-border/50 bg-secondary/30 hover:border-primary/30")}>
