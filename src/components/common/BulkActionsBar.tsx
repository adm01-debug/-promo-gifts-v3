  ...
  return (
    <AnimatePresence>
      {selectedCount > 0 && (
        ...
        >
          <div className="flex items-center gap-3 px-4 py-2 bg-primary/10 border border-primary/30 rounded-md flex-wrap">
          ...
          {showSelectAllBanner && totalCount && onSelectAll && (
            <div className="flex items-center justify-center gap-2 px-4 py-1.5 bg-muted/50 border border-border rounded-md text-sm text-muted-foreground">
              <span>
