      ...
      <CardHeader className="pb-4">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            <div className="rounded-xl bg-gradient-to-br from-success to-success/80 p-2 text-success-foreground shadow-lg">
            ...
            {Array.from({ length: 4 }).map((_, i) => (
              <Card key={i} className="border-border/50">
                <CardContent className="p-3">
                  <Skeleton className="mb-3 aspect-square rounded-xl" />
                    ...
                    <CardContent className="p-0">
                      ...
                      <div className="space-y-1.5 p-3">
                        ...
                        <div className="flex items-center justify-between text-[11px] text-muted-foreground">
                          <span className={cn(fresh ? 'font-medium text-orange' : '')}>
