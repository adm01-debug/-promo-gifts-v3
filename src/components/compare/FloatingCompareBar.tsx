      ...
      <AnimatePresence>
        <motion.div
          ...
          className={cn(
            ...
            'rounded-xl border border-border/50 bg-card/95 shadow-2xl backdrop-blur-xl',
        ...
        >
          ...
          <div className="scrollbar-none flex min-w-0 flex-1 items-center gap-2 overflow-x-auto">
              ...
              >
                <Tooltip>
                  <TooltipTrigger asChild>
                    <div className="h-12 w-12 cursor-pointer overflow-hidden rounded-xl border-2 border-border/50 bg-muted transition-colors hover:border-primary/50">
                      <img
            ...
            {Array.from({ length: 4 - compareCount }).map((_, idx) => (
              <div
                key={`empty-${idx}`}
                className="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl border-2 border-dashed border-border/50"
              >
          ...
          <div className="flex flex-shrink-0 items-center gap-2">
            ...
            >
              Comparar
              <span className="rounded-xl bg-orange-foreground/20 px-1.5 py-0.5 text-xs">
                {compareCount}
              </span>
