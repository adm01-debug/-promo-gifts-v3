            ...
            <div className="flex items-center gap-2 overflow-x-auto">
              {entries.map((entry) => (
                <div
                  ...
                  className="flex items-center gap-2 px-2 py-1 rounded-md bg-card border border-border shrink-0 min-w-[180px]"
                >
                  <img
                      ...
                      <div className="relative group" data-compare-product={entry.index}>
                        ...
                        <div className="flex flex-col items-center gap-2">
                          <img
                            src={hoveredVariant[entry.index] ?? entry.product.images[0]}
                            alt={entry.product.name}
                            className="w-24 h-24 rounded-md object-cover cursor-pointer hover:ring-2 hover:ring-primary transition-all"
