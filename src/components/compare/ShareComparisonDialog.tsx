...
export function ShareComparisonDialog({ open, onOpenChange, compareItems, clientId, clientName }: Props) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Gere um link público para enviar essa comparação ao seu cliente. Ele poderá visualizar e reagir aos produtos sem precisar de conta.
          </DialogDescription>
        </DialogHeader>
