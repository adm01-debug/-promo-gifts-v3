    ...
    <div className="space-y-6">
      ...
      <div className="divide-y divide-border overflow-hidden rounded-xl border">
        {wizard.personalizations.map((pers, idx) => (
          ...
          >
            <div className="flex h-7 w-7 shrink-0 items-center justify-center rounded-xl bg-primary/10 text-sm font-bold text-primary">
              {idx + 1}
            </div>
            ...
            <div className="flex flex-col justify-between rounded-xl border border-white/10 bg-black/15 p-4 backdrop-blur-sm">
              ...
              {wizard.totals.maxDays > 0 ? (
                ...
                <div className="group relative flex cursor-help items-center gap-2">
                  ...
                  <div className="pointer-events-none absolute bottom-full left-0 z-10 mb-2 w-48 rounded-xl bg-black/90 px-3 py-2 text-xs text-primary-foreground opacity-0 shadow-xl transition-opacity group-hover:opacity-100">
      ...
      {showDuplicateQty && (
        ...
        >
          ...
          <Input
            ...
            min={1}
            className="h-9 w-28 rounded-xl text-center font-bold"
          />
          <Button
            size="sm"
