  ...
  return (
    <div className="mx-auto max-w-6xl space-y-6">
      ...
      <div className="flex flex-col items-start gap-4 sm:flex-row sm:items-center sm:gap-8">
        ...
        <div className="flex shrink-0 items-center gap-4 rounded-xl border bg-card p-4">
        ...
        <div className="flex items-center gap-2 overflow-x-auto pb-1">
          ...
          {drafts.slice(0, 4).map((draft) => (
            <Button
              ...
              variant="outline"
              size="sm"
              className="h-7 shrink-0 gap-1.5 rounded-xl text-xs"
              onClick={() => {
      ...
      <div className="relative">
        ...
        <Input
          ...
          className="h-14 rounded-xl border-0 bg-muted/30 pl-12 pr-12 text-base shadow-sm focus-visible:ring-2 focus-visible:ring-primary/40"
        />
        {searchTerm && (
          <Button
            variant="ghost"
      ...
      >
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 text-muted-foreground">
            <div className="mb-5 rounded-xl border border-primary/10 bg-primary/5 p-5">
      ...
      {wizard.selectedProduct && (
        ...
        >
          ...
          {/* CTA bar */}
          <div className="flex items-center justify-between rounded-xl border border-primary/20 bg-gradient-to-r from-primary/10 to-primary/5 p-5">
            ...
            <Button
              className="h-12 gap-2 rounded-xl px-8 text-base shadow-lg shadow-primary/20"
              size="lg"
