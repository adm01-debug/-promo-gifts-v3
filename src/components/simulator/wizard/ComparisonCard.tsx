...
import { Trophy, Zap, Clock, DollarSign, AlertTriangle, Check, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="relative">
      {isBestValue && !isSelected && (
        <div className="pointer-events-none absolute -inset-px rounded-xl bg-gradient-to-r from-warning/40 via-primary/30 to-warning/40 blur-sm" />
      )}
      <button
        onClick={() => onSelect(result)}
        className={cn(
          'group relative w-full rounded-xl p-6 text-left transition-all duration-300',
        ...
        <div className="flex items-start justify-between gap-5">
          ...
          <div className="min-w-0 flex-1">
            <div className="mb-1 flex flex-wrap items-center gap-3">
              ...
              {isBestValue && (
                <Badge className="gap-1.5 border-0 bg-gradient-to-r from-warning to-orange px-3 py-1 text-sm text-primary-foreground shadow-lg shadow-warning/25">
          ...
          <div className="shrink-0 text-right">
            <div className="min-w-[140px] rounded-xl bg-muted/50 p-4 transition-colors group-hover:bg-primary/5">
