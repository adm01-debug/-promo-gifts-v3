    ...
    <div className="mx-auto max-w-5xl space-y-8">
          ...
          <>
            ...
            {unavailableResults.map((result) => (
              <motion.div
                ...
                initial={{ opacity: 0 }}
                animate={{ opacity: 0.6 }}
                className="rounded-xl border border-dashed bg-muted/30 p-5"
              >
                <div className="flex items-center justify-between">
                  <div>
      ...
      <AnimatePresence>
        {selectedIds.size > 0 && (
          ...
          >
            <div className="flex items-center justify-between rounded-xl border border-primary/30 bg-gradient-to-r from-primary to-primary/90 p-4 text-primary-foreground shadow-2xl shadow-primary/40">
              <div>
