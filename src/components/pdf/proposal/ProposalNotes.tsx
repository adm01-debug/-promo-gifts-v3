        ...
        <div style={{ paddingTop: '8px' }}>
          ...
          <div style={{ fontSize: '9px', color: '#555', lineHeight: '1.38' }}>
            <div style={{ marginBottom: '4px' }}>
              ...
              proposta constitui oferta formal (art. 427, Codigo Civil). A resposta do destinatario
              com expressoes de concordancia ("aprovado", "aceito", "de acordo" ou equivalentes),
              por e-mail ou aplicativo de mensagens, configura aceitacao plena de todos os termos,
              valores, prazos e especificacoes aqui descritos, formando contrato valido e vinculante
              (arts. 104, 107 e 427 a 435 do Codigo Civil).
            </div>
            <div>
              ...
              vincular a empresa identificada no campo "EMPRESA" a presente contratacao, estando
              autorizado a firmar compromissos comerciais nas condicoes aqui estipuladas.
            </div>
          </div>
        </div>
      </div>
