...
export function ExternalCollectionCard({
  ...
  if (viewMode === 'list') {
    return (
      ...
      >
        <div
          className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-xl text-lg"
          style={{
  ...
  return (
    <motion.div
      ...
      className="group relative cursor-pointer overflow-hidden rounded-xl border-[1.5px] border-border/40 bg-card shadow-sm transition-all duration-500 hover:border-primary/40"
      onClick={onNavigate}
    >
      <div
      ...
      <div className="space-y-3 p-4">
        ...
        <div className="flex items-center justify-between">
          <span className="inline-flex items-center gap-1.5 rounded-xl bg-muted/50 px-2.5 py-1 text-xs font-medium text-muted-foreground">
