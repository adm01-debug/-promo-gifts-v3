...
export function CollectionGridCard({
  ...
  return (
    <motion.div
      ...
      className={cn(
        'group relative cursor-pointer overflow-hidden rounded-xl bg-card shadow-sm transition-all duration-500',
      ...
      <div className="relative aspect-[3/4] overflow-hidden bg-muted/20">
        {hasImages ? (
          ...
          <div className="flex h-full flex-col items-center justify-center gap-4">
            <div className="flex h-16 w-16 items-center justify-center rounded-xl border border-border/20 bg-muted/15">
      ...
      <div className="space-y-3 border-t border-border/20 bg-card p-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3 text-xs text-muted-foreground">
            <span className="inline-flex items-center gap-1.5 rounded-xl bg-muted/50 px-2.5 py-1 font-medium">
              <Package className="h-3 w-3 text-primary" />
