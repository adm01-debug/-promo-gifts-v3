...
export function CollectionsHeatmap() {
  ...
  return (
    <div className="flex items-center gap-3 px-3 py-2 rounded-md border border-border bg-card/50">
      <div className="flex items-end gap-0.5 h-8" aria-label="Histórico semanal de coleções">
        {data.map((d, i) => {
