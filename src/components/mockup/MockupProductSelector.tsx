...
export function MockupProductSelector({ selection, onSelect, disabled }: MockupProductSelectorProps) {
  ...
  if (selection) {
    return (
      <div className="flex items-center gap-3 p-3 rounded-2xl border border-border/30 bg-card">
        <div className="w-11 h-11 rounded-2xl bg-muted overflow-hidden shrink-0">
          <img
