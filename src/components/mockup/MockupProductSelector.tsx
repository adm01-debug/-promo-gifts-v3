                ...
                {isLoadingProducts || isFilterPending ? (
                  <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4">
                    {Array.from({ length: 12 }).map((_, i) => (
                      <div
                        key={i}
                        className="space-y-3 rounded-xl border border-border/30 bg-card p-3"
                      >
                        ...
                        >
                          {rowItems.map((product) => (
                            <div
                              ...
                              className="group relative flex cursor-pointer flex-col rounded-xl border border-border/30 bg-card p-3 outline-none transition-all duration-300 hover:border-primary/50 hover:shadow-xl hover:shadow-primary/5 focus-visible:ring-2 focus-visible:ring-primary"
                              role="button"
                              tabIndex={0}
