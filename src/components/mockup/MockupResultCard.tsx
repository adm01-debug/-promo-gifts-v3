        ...
        <CardContent className="space-y-3 p-4">
          ...
          {showBeforeAfter && beforeImage ? (
            ...
            >
              ...
              {/* Zoom Controls */}
              <div className="absolute bottom-3 right-3 flex items-center gap-1 rounded-xl border bg-background/80 p-1 shadow-sm backdrop-blur-sm">
                <Button
                  size="icon"
                  variant="ghost"
                  className="h-7 w-7"
        ...
        <Dialog open={isFullscreen} onOpenChange={setIsFullscreen}>
          <DialogContent className="h-auto max-h-[95vh] w-auto max-w-[95vw] border-0 bg-background/95 p-0 backdrop-blur-xl [&>button]:hidden">
            <div className="relative flex h-full min-h-[60vh] w-full flex-col items-center justify-center">
              ...
              {!isClientMode && (
                <div className="absolute bottom-4 left-1/2 z-10 flex -translate-x-1/2 items-center gap-1 rounded-xl border bg-background/90 p-1.5 shadow-lg backdrop-blur-sm">
                  <Button
                    size="icon"
                    aria-label="Reduzir"
                    variant="ghost"
