        ...
        <div className="space-y-6 py-2">
          ...
          {category === 'laser' && (
            <div className="space-y-3">
                ...
                {(Object.entries(LASER_TONES) as [LaserTone, typeof LASER_TONES.claro][]).map(
                  ([key, tone]) => (
                    <label
                      key={key}
                      className={cn(
                        'relative flex cursor-pointer flex-col items-center gap-2 rounded-xl border-2 p-4 transition-all',
                        laserTone === key
              ...
              <div className="flex items-start gap-2 rounded-xl bg-muted/50 p-2.5 text-xs text-muted-foreground">
          ...
          {category === 'serigrafia' && (
            <div className="space-y-4">
              ...
              {detectedColors.length > 0 ? (
                ...
                <div className="flex items-start gap-2 rounded-xl border border-warning/20 bg-warning/5 p-3 dark:border-warning/40 dark:bg-warning/10">
