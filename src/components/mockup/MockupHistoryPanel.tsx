  ...
  return (
    <Card className="border-border/30">
      ...
      <CardContent className="space-y-4">
        {/* Filters */}
        <div className="grid grid-cols-1 gap-4 rounded-xl bg-muted/30 p-4 md:grid-cols-4">
    ...
    return (
      ...
      >
        <div className="absolute left-2 top-2 z-10">
          <div
            className={cn(
              'flex h-6 w-6 cursor-pointer items-center justify-center rounded-xl border-2 bg-background/80 backdrop-blur-sm transition-all',
              isCompareSelected
        ...
        <div className="space-y-1.5 border-t bg-gradient-to-t from-muted/50 to-transparent p-3">
          <Tooltip>
            ...
            <TooltipContent>
              ...
              {mockup.product_sku && (
                <p className="text-[11px] text-muted-foreground">SKU: {mockup.product_sku}</p>
              )}
            </TooltipContent>
          </Tooltip>
          {mockup.product_sku && (
...
const MockupListRow = memo(
  ({
    ...
    return (
      <div
        className={cn(
          'group flex items-center gap-4 rounded-xl border border-border/30 bg-card p-3 transition-all duration-200 hover:shadow-md hover:ring-2 hover:ring-primary/30',
          isCompareSelected && 'shadow-lg ring-2 ring-primary',
        )}
      >
        <div
        ...
        <div className="h-20 w-16 flex-shrink-0 overflow-hidden rounded-xl border bg-muted/30">
          <img
            src={mockup.layout_url || mockup.mockup_url}
