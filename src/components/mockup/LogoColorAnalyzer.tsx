...
export function LogoColorAnalyzer({
  ...
  return (
    <div className={cn("space-y-3", className)}>
      ...
      {exceedsMax && (
        <div className="flex items-center gap-2 px-3 py-2 rounded-2xl bg-destructive/10 border border-destructive/20">
...
function ColorRow({ color, index, onPantoneChange }: ColorRowProps) {
  return (
    <div className="grid grid-cols-2 gap-2 items-center">
      {/* Detected color */}
      <div className="flex items-center gap-2 px-2 py-1.5 rounded-2xl bg-muted/30">
        <div
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <button
          className="flex items-center gap-2 px-2 py-1.5 rounded-2xl border border-border/50 
