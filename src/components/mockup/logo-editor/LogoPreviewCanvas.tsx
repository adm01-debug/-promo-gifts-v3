...
export function LogoPreviewCanvas({
  ...
  return (
    <>
      ...
      {techniqueName && (
        <div className="flex items-center gap-2 p-2 rounded-2xl bg-primary/5 border border-primary/20">
          <div
      ...
      <div
        ref={containerRef}
        className="relative rounded-2xl border overflow-hidden bg-muted/30 aspect-square"
      >
        <img
          src={productImageUrl}
