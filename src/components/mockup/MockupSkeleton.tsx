      ...
      >
        <CardContent className="p-4 space-y-4">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className={cn("h-8 w-20 rounded-2xl", shimmerClass)} />
          </div>
          ...
          <div className="flex gap-2">
            <div className={cn("h-9 flex-1 rounded-2xl", shimmerClass)} />
            <div className={cn("h-9 flex-1 rounded-2xl", shimmerClass)} />
          </div>
        ...
        <CardContent className="p-6 space-y-6">
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="space-y-2" style={{ animationDelay: `${i * 100}ms` }}>
              ...
              <div className={cn("h-10 w-full rounded-2xl", shimmerClass)} />
            </div>
          ))}

          {/* Button skeleton */}
          <div className="flex gap-2 pt-4">
            <div className={cn("h-10 flex-1 rounded-2xl", shimmerClass)} />
            <div className={cn("h-10 w-10 rounded-2xl", shimmerClass)} />
          </div>
        </CardContent>
      </Card>
    );
