            ...
            <div className="mb-2 border-b border-border/50 pb-2">
              ...
              {history.slice(0, 3).map((item) => (
                <div key={item.id} className="group relative">
                  <button
                    type="button"
                    className="flex w-full items-center gap-2 rounded-xl px-2 py-1 text-left text-sm hover:bg-accent/50"
            ...
            >
              {company.logo_url ? (
                <img
                  ...
                  alt="Logo da empresa"
                  className="h-6 w-6 flex-shrink-0 rounded border border-border bg-background object-contain"
                  loading="lazy"
                />
              ) : (
