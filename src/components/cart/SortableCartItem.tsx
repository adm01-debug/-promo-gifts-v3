    ...
    >
      ...
      >
        ...
        <div className="group/img-container relative aspect-square overflow-hidden bg-muted/20">
          <div className="absolute left-2.5 top-2.5 z-30 flex items-center gap-1.5 opacity-0 transition-all duration-300 group-hover:opacity-100">
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  {...attributes}
                  {...listeners}
                  className="flex h-8 w-8 cursor-grab items-center justify-center rounded-xl border border-border/50 bg-card/90 text-muted-foreground shadow-sm backdrop-blur-md hover:text-primary active:cursor-grabbing"
                  aria-label="Arrastar"
                >
            ...
            {onToggleSelection && (
              <button
                ...
                className={cn(
                  'flex h-8 w-8 items-center justify-center rounded-xl border shadow-sm backdrop-blur-md transition-all',
                  isSelected
                    ? 'scale-110 border-primary/20 bg-primary text-primary-foreground'
                    : 'border-border/50 bg-card/90 text-muted-foreground hover:text-primary',
                )}
          ...
          {isSelected && (
            <div className="absolute inset-0 z-10 bg-primary/5 ring-4 ring-inset ring-primary/30 transition-all" />
          )}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 rounded-xl p-1.5">
                ...
                <DropdownMenuItem
                  ...
                  className="rounded-xl py-2 text-destructive focus:bg-destructive/5 focus:text-destructive"
        ...
        <div className="space-y-2.5 p-3.5">
          ...
          <div className="flex items-center justify-between rounded-xl border border-border/10 bg-muted/20 p-2">
            <PriceLabel
              label="Unitário"
          ...
          <div className="flex items-center justify-between gap-3 border-t border-border/30 pt-2">
            <div
              ...
              className="flex items-center gap-0 overflow-hidden rounded-xl border border-border/50 bg-background shadow-sm transition-colors hover:border-primary/30"
            >
              <button
          ...
          <Collapsible open={notesOpen} onOpenChange={setNotesOpen}>
            <CollapsibleTrigger asChild>
              <button
                ...
                className={cn(
                  'flex w-full items-center gap-2 rounded-xl border border-transparent p-2 text-[10px] font-bold uppercase tracking-wider transition-all',
                  item.notes
