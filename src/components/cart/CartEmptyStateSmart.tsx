            ...
            <>
              <ul className="flex-1 space-y-2 text-xs text-muted-foreground">
                {topTemplates.map((t) => (
                  <li
                    key={t.id}
                    className="flex items-center justify-between gap-3 rounded-xl bg-muted/30 p-2 transition-colors hover:bg-muted/50"
                  >
