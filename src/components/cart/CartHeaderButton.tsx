        ...
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            ...
            >
              ...
              {totalItems > 0 && (
                <Badge
                  className="absolute -top-0.5 -right-0.5 h-4 min-w-4 px-1 flex items-center justify-center text-[9px] bg-primary text-primary-foreground border-0"
                >
            ...
            {carts.length === 0 ? (
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-xs text-muted-foreground mb-3">
                  Crie um carrinho para começar a coletar produtos
                </p>
                <Button
                  size="sm"
