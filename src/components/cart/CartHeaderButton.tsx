  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      <PopoverContent
        ...
        className="w-[420px] p-0 rounded-lg border-border/50 shadow-xl overflow-hidden"
        align="end"
        sideOffset={8}
            ...
            >
              ...
              <div className="px-4 pt-4 pb-3 flex items-center justify-between border-b border-border/40 bg-muted/5">
                <div className="flex items-center gap-2.5">
                  <div className="h-8 w-8 rounded-lg bg-primary/10 flex items-center justify-center shadow-inner">
              ...
              {isLoading ? (
                <div className="p-3 space-y-3">
                  {[...Array(2)].map((_, i) => (
                    <div key={i} className="rounded-lg border border-border/40 p-3 space-y-4 animate-pulse">
                      <div className="flex items-center gap-2.5">
                ...
                <div className="px-4 pb-5 pt-6 text-center">
                  <div className="w-14 h-14 mx-auto mb-3 rounded-lg bg-muted/30 flex items-center justify-center">
                      ...
                      {carts.map((cart) => {
                        ...
                        return (
                          <div
                            key={cart.id}
                            className={cn(
                              "rounded-lg border transition-all duration-200 cursor-pointer group",
                              isActive
                            ...
                            <div className="flex items-center gap-2.5 px-3 py-2.5">
                              ...
                              <div className="flex items-center gap-1.5 flex-shrink-0">
                                ...
                                <TooltipProvider >
                                  ...
                                  <TooltipTrigger asChild>
                                    <button
                                      className="h-7 w-7 flex items-center justify-center rounded-lg text-muted-foreground hover:text-destructive hover:bg-destructive/10 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100"
