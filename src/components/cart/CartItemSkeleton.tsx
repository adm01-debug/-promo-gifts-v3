  ...
  return (
    <Card className="overflow-hidden border-border/40 shadow-sm animate-pulse group">
      <div className="aspect-square w-full bg-muted/10 relative">
        ...
        <div className="absolute top-2 left-2 h-7 w-7 rounded-md bg-card/40 backdrop-blur-sm border border-white/10" />
        <div className="absolute top-2 right-2 h-7 w-7 rounded-md bg-card/40 backdrop-blur-sm border border-white/10" />
      ...
      <div className="p-3.5 space-y-4">
        ...
        <div className="flex items-center justify-between pt-3.5 border-t border-border/10">
          <Skeleton className="h-8 w-24 rounded-md opacity-30" />
