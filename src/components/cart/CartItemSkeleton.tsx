  ...
  return (
    <Card className="group animate-pulse overflow-hidden border-border/40 shadow-sm">
      <div className="relative aspect-square w-full bg-muted/10">
        ...
        <div className="absolute left-2 top-2 h-7 w-7 rounded-xl border border-white/10 bg-card/40 backdrop-blur-sm" />
        <div className="absolute right-2 top-2 h-7 w-7 rounded-xl border border-white/10 bg-card/40 backdrop-blur-sm" />
