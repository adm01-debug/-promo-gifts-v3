                ...
                <Card key={cart.id} className="space-y-3 p-4">
                  <div className="flex items-center gap-2">
                    {cart.company_logo_url ? (
                      <img
                        ...
                        alt="Logo da empresa"
                        className="h-8 w-8 rounded-xl border border-border/50 bg-background object-contain p-0.5"
                        loading="lazy"
                      />
                    ) : (
                  ...
                  <div className="max-h-48 space-y-1.5 overflow-y-auto">
                    {cart.items.map((item) => (
                      <div
                        key={item.id}
                        className="flex items-center gap-2 rounded-xl bg-muted/30 p-1.5 text-xs"
                      >
