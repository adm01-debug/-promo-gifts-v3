    ...
    <Card>
      <CardContent className="p-5 sm:p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <span className="text-sm font-mono font-semibold text-foreground bg-muted px-3 py-1 rounded-2xl">
            {value}px
          </span>
        </div>
        ...
        <div className="flex gap-1.5 mb-4 flex-wrap">
          {QUICK_PRESETS.map((preset) => (
            <button
              ...
              className={cn(
                'text-[11px] font-medium px-3 py-1.5 rounded-2xl transition-all',
                value === preset.value
