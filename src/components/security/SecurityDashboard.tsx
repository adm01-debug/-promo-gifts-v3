...
import {
  ...
  Eye, Bell, History, MapPin, Fingerprint, Users,
} from 'lucide-react';
    ...
    <div className="space-y-6">
        ...
        <Card className="col-span-full lg:col-span-2">
          ...
          <CardContent>
            <div className="flex items-center gap-6">
              <div className="flex flex-col items-center justify-center p-4 bg-muted rounded-2xl">
          ...
          <CardContent>
            <div className="space-y-3">
              {recommendations.map((rec, idx) => (
                <div key={idx} className="flex items-start gap-3 p-3 rounded-2xl bg-background">
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="flex flex-wrap h-auto gap-1">
          ...
          <TabsTrigger value="passkeys" className="flex items-center gap-2"><Fingerprint className="h-4 w-4" /><span className="hidden sm:inline">Passkeys</span></TabsTrigger>
                ...
                <ScrollArea className="h-[300px]">
                  <div className="space-y-3">
                    {loginAttempts.slice(0, 10).map((attempt) => (
                      <div key={attempt.id} className="flex items-center justify-between p-2 rounded-2xl border">
                ...
                <ScrollArea className="h-[300px]">
                  <div className="space-y-3">
                    {notifications.map((notif) => (
                      <div key={notif.id} className={`p-3 rounded-2xl border ${!notif.is_read ? 'bg-primary/5 border-primary/20' : ''}`}>
        ...
        <TabsContent value="passkeys"><PasskeyManager targetUserId={isManagingOther ? selectedUserId! : undefined} /></TabsContent>
              ...
              <ScrollArea className="h-[400px]">
                <div className="space-y-2">
                  {loginAttempts.map((attempt) => (
                    <div key={attempt.id} className={`flex items-center justify-between p-3 rounded-2xl border ${!attempt.success ? 'border-destructive/20 bg-destructive/5' : ''}`}>
                      <div className="flex items-center gap-4">
                        {attempt.success ? (
