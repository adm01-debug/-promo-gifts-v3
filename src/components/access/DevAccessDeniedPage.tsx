        ...
        <div className="w-full max-w-md flex flex-col items-center gap-6 text-center">
          ...
          <div className="space-y-4 w-full">
            ...
            <div className="space-y-3">
              ...
              {isSupervisor && (
                <div className="mx-auto max-w-sm p-3 rounded-2xl bg-muted/40 border border-border/50 text-xs text-left">
          ...
          <div className="w-full text-left rounded-2xl border border-border/60 bg-muted/20 p-3">
