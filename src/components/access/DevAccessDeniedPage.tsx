        ...
        <div className="flex w-full max-w-md flex-col items-center gap-6 text-center">
          ...
          <div className="w-full space-y-4">
            <div className="space-y-1">
              <span className="badge-premium-destructive px-2 py-0.5 text-[10px]">
                {copy.badge} · 403
              </span>
              <h1
            ...
            <div className="space-y-3">
              ...
              {isSupervisor && (
                <div className="mx-auto max-w-sm rounded-xl border border-border/50 bg-muted/40 p-3 text-left text-xs">
            ...
            <div className="border-t border-border/10 pt-2">
              ...
              <p className="badge-premium-mono mt-1.5">{securityId}</p>
            </div>
          </div>
          ...
          <div className="w-full space-y-2 text-left">
            <label htmlFor="dev-access-reason" className="text-[11px] font-medium text-foreground">
              Motivo (opcional)
            </label>
            <Textarea
          ...
          <div className="flex w-full flex-col gap-2 pt-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Button variant="outline" onClick={handleCopyLink} className="h-9 gap-2">
