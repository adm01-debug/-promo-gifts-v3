...
export function QuoteValidityBanner({ validUntil, status }: QuoteValidityBannerProps) {
  ...
  if (status === "expired" || daysLeft < 0) {
    return (
      <div className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-destructive/10 border border-destructive/20 text-destructive">
  ...
  if (daysLeft <= 3) {
    return (
      <div className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-warning/10 border border-warning/20 text-warning">
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-primary/10 border border-primary/20 text-primary dark:text-primary">
