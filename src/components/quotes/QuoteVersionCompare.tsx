                    ...
                    <div key={detail.id} className="space-y-2">
                      ...
                      {detail.items.map((item, i) => {
                        ...
                        return (
                          <div
                            key={item.id}
                            className={`rounded-xl border p-2 text-xs ${isNew ? 'bg-success/5/50 border-success/30 dark:bg-success/10' : changed ? 'bg-warning/5/50 border-warning/30 dark:bg-warning/10' : 'border-border'}`}
                          >
