        ...
        <td className="p-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              {item.product_sku && (
                <span
                  className="mb-1 inline-flex items-center gap-1 rounded-xl border px-2 py-0.5 font-mono text-xs font-semibold"
                  style={{
              ...
              <div className="space-y-1.5">
                ...
                {allPersonalizations.map((p: any, pIdx: number) => {
                  ...
                  return (
                    ...
                    >
                      <div className="bg-primary/8 inline-flex flex-col gap-0.5 rounded-xl border border-primary/20 px-2 py-1.5">
