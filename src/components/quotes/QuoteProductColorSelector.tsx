  ...
  return (
    <div className="space-y-4">
      ...
      <button
        ...
        className="w-full flex items-center gap-3 p-3 rounded-2xl border border-dashed border-border hover:border-primary/50 hover:bg-muted/50 transition-colors text-left text-sm text-muted-foreground"
      >
        ...
        {sortedVariants.map((variant) => {
          ...
          return (
            <button
              ...
              className={cn(
                'relative flex items-center gap-2.5 p-3 rounded-2xl border transition-all text-left',
            ...
            >
              ...
              {variant.selected_thumbnail ? (
                ...
                <div
                  className="w-10 h-10 rounded-2xl border border-border shrink-0"
