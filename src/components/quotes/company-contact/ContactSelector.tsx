...
export function ContactDropdown({ contacts, contactId, onContactChange, onContactInfoChange }: ContactDropdownProps) {
  ...
  return (
    <div ref={ref} className="relative">
      <button type="button" className={cn("flex h-10 w-full items-center justify-between rounded-2xl border border-input bg-background px-3 py-2 text-sm ring-offset-background focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 hover:bg-accent/50 transition-colors")}
      ...
      {open && (
        <div className="absolute z-50 mt-1 w-full rounded-2xl border border-border bg-popover shadow-lg max-h-[280px] overflow-y-auto">
...
export function SingleContactDisplay({ contact, contactId, onContactChange, onContactInfoChange }: {
  ...
  return (
    <div className="flex h-10 w-full items-center justify-between rounded-2xl border border-input bg-background px-3 py-2 text-sm">
