    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        {!companyId ? (
          <div
            className={cn(
              'flex h-10 w-full items-center rounded-xl border border-input bg-background px-3 py-2 text-sm text-muted-foreground',
            )}
          >
          ...
          <div
            className={cn(
              'flex h-10 w-full items-center gap-2 rounded-xl border border-input bg-background px-3 py-2 text-sm text-muted-foreground',
            )}
          >
