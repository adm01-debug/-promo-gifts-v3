          ...
          <div className="flex items-start gap-3">
            {item.product_image_url && (
              <img
                ...
                className="w-16 h-16 object-cover rounded-md border border-border" loading="lazy" />
            )}
                  ...
                  {personalizations.map((p, idx) => {
                    ...
                    return (
                      <div key={idx} className="space-y-3">
                        <div className="bg-muted/50 rounded-md p-3 space-y-2.5 border border-border/50">
                          {/* Technique */}
