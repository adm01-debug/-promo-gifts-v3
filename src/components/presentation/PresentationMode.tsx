        ...
        <div className="flex-1 overflow-auto p-8 pt-20">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            ...
            <button
              onClick={() => goTo(0)}
              className={cn(
                "aspect-video rounded-2xl border-2 overflow-hidden transition-all hover:scale-105",
            ...
            {slides.map((s, i) => (
              <button
                ...
                onClick={() => goTo(i + 1)}
                className={cn(
                  "aspect-video rounded-2xl border-2 overflow-hidden transition-all hover:scale-105 relative",
