        ...
        <div className="flex-1 overflow-auto p-8 pt-20">
          <div className="mx-auto grid max-w-6xl grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            ...
            <button
              onClick={() => goTo(0)}
              className={cn(
                'aspect-video overflow-hidden rounded-xl border-2 transition-all hover:scale-105',
            ...
            {slides.map((s, i) => (
              <button
                ...
                onClick={() => goTo(i + 1)}
                className={cn(
                  'relative aspect-video overflow-hidden rounded-xl border-2 transition-all hover:scale-105',
              ...
              <div className="flex w-full max-w-6xl flex-col items-center gap-8 md:flex-row md:gap-16">
                ...
                <div className="flex max-h-[70vh] w-full flex-shrink-0 items-center justify-center md:w-1/2">
                  {slide.imageUrl ? (
                    ...
                    <div className="flex h-80 w-80 items-center justify-center rounded-xl border border-white/10 bg-white/5">
                ...
                <div className="max-w-lg flex-1 space-y-4 text-left">
                  ...
                  {slide.subtitle && <p className="text-xl text-white/50">{slide.subtitle}</p>}
                  {slide.description && (
