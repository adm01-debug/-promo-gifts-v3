        ...
        <Popover open={isOpen} onOpenChange={setIsOpen}>
          ...
          >
            ...
            <button aria-label="Fechar"
              className="absolute top-3 right-3 h-7 w-7 flex items-center justify-center rounded-md text-muted-foreground hover:text-foreground hover:bg-muted/60 transition-colors z-10"
                    ...
                    >
                      ...
                      {item.imageUrl ? (
                        <img
                          src={item.imageUrl}
                          alt=""
                          className="w-10 h-10 rounded-md object-contain bg-background border border-border/30 flex-shrink-0 p-0.5" loading="lazy" />
                      ) : (
                        <div className="w-10 h-10 rounded-md bg-muted/40 flex-shrink-0 flex items-center justify-center">
