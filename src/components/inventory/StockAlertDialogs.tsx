...
function AlertSummaryBar({ alerts, variant }: { alerts: StockAlert[]; variant: 'critical' | 'warning' }) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
      <div className={`rounded-2xl border p-2.5 text-center ${isCritical ? 'bg-destructive/5 border-destructive/15' : 'bg-warning/5 border-warning/15'}`}>
      ...
      <div className="rounded-2xl border bg-muted/30 p-2.5 text-center">
        <p className="text-[11px] text-muted-foreground">Produtos</p>
        <p className="text-xl font-bold tabular-nums">{stats.products}</p>
      </div>
      {stats.outOfStock > 0 && (
        <div className="rounded-2xl border bg-destructive/5 border-destructive/15 p-2.5 text-center">
      ...
      {stats.lowStock > 0 && (
        <div className="rounded-2xl border bg-warning/5 border-warning/15 p-2.5 text-center">
