...
function AlertSummaryBar({
  ...
  return (
    <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
      <div
        className={`rounded-xl border p-2.5 text-center ${isCritical ? 'border-destructive/15 bg-destructive/5' : 'border-warning/15 bg-warning/5'}`}
      >
      ...
      {stats.outOfStock > 0 && (
        <div className="rounded-xl border border-destructive/15 bg-destructive/5 p-2.5 text-center">
