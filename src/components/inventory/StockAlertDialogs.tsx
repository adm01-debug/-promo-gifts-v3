...
function AlertSummaryBar({ alerts, variant }: { alerts: StockAlert[]; variant: 'critical' | 'warning' }) {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
      <div className={`rounded-xl border p-2.5 text-center ${isCritical ? 'bg-destructive/5 border-destructive/15' : 'bg-warning/5 border-warning/15'}`}>
      ...
      {stats.outOfStock > 0 && (
        <div className="rounded-xl border bg-destructive/5 border-destructive/15 p-2.5 text-center">
      ...
      {stats.lowStock > 0 && (
        <div className="rounded-xl border bg-warning/5 border-warning/15 p-2.5 text-center">
