      ...
      <div className="p-4">
        <div className="flex items-center justify-between gap-3">
          <div className="min-w-0 flex-1 space-y-1 text-left">
            <p className="mb-1 text-[10px] font-bold uppercase leading-none tracking-widest text-muted-foreground opacity-70 transition-opacity group-hover:opacity-100">
              {title}
            </p>
            <p className="text-2xl font-extrabold tabular-nums leading-none tracking-tighter">
              {displayValue}
            </p>
            {subtitle && (
