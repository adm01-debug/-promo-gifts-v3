  ...
  return (
    <div className={cn("rounded-xl border p-3 transition-all hover:shadow-sm", styles[variant])}>
      <div className="flex items-center gap-2 mb-2">
        <div className={cn("h-7 w-7 rounded-2xl flex items-center justify-center", iconStyles[variant])}>
...
function EntryRow({ entry }: { entry: FutureStockEntry }) {
  ...
  return (
    <div
      className={cn(
        "grid grid-cols-[1fr_90px_110px_100px_70px] gap-2 px-3 py-2.5 rounded-2xl border transition-all duration-200",
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-4xl max-h-[90vh] flex flex-col">
        ...
        {stats.overdueCount > 0 && (
          <div className="flex items-center gap-2 px-3 py-2 rounded-2xl bg-destructive/10 border border-destructive/20 text-destructive text-sm">
        ...
        <ScrollArea className="flex-1 max-h-[45vh]">
          {filtered.length === 0 ? (
            ...
            <div className="space-y-1">
              {/* List Header */}
              <div className="grid grid-cols-[1fr_90px_110px_100px_70px] gap-2 px-3 py-2 bg-muted/30 rounded-2xl text-xs font-medium text-muted-foreground sticky top-0 z-[1]">
