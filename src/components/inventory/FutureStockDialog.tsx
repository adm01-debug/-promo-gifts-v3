  ...
  return (
    <div className={cn('rounded-xl border p-3 transition-all hover:shadow-sm', styles[variant])}>
      <div className="mb-2 flex items-center gap-2">
        <div
          className={cn('flex h-7 w-7 items-center justify-center rounded-xl', iconStyles[variant])}
        >
...
function EntryRow({ entry }: { entry: FutureStockEntry }) {
  ...
  return (
    <div
      className={cn(
        'grid grid-cols-[1fr_90px_110px_100px_70px] gap-2 rounded-xl border px-3 py-2.5 transition-all duration-200',
        ...
        <ScrollArea className="max-h-[45vh] flex-1">
          {filtered.length === 0 ? (
            ...
            <div className="space-y-1">
              {/* List Header */}
              <div className="sticky top-0 z-[1] grid grid-cols-[1fr_90px_110px_100px_70px] gap-2 rounded-xl bg-muted/30 px-3 py-2 text-xs font-medium text-muted-foreground">
                <button
                  type="button"
