...
export const RiskTooltip = forwardRef<HTMLDivElement, any>(function RiskTooltip(
  { active, payload },
  ref,
) {
  ...
  return (
    <div
      ref={ref}
      className="min-w-[150px] rounded-xl border border-border bg-popover p-2.5 shadow-lg"
    >
