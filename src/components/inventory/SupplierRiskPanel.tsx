    ...
    <Card>
      <CardHeader className="pb-3">
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div>
            <CardTitle className="flex items-center gap-2 font-display text-xl font-bold tracking-tight">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-amber-500/10 shadow-inner">
              ...
              {globalCounts.critical > 0 && (
                <Badge
                  variant="destructive"
                  className="h-5 animate-pulse border-none px-1.5 text-[10px] font-bold uppercase shadow-md shadow-destructive/20"
                >
                    ...
                    return (
                      ...
                      >
                        <button
                          ...
                          className={cn(
                            'w-full rounded-xl p-2 text-left text-xs transition-colors',
