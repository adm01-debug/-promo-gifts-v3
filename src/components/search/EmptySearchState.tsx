  ...
  return (
    <div className="flex flex-col gap-4 px-4 py-6 duration-300 animate-in fade-in-0 zoom-in-95">
      <div className="flex items-center gap-3">
        <div className="flex h-12 w-12 items-center justify-center rounded-xl border [background-color:hsl(var(--command-surface-raised))] [border-color:hsl(var(--command-border))]">
          ...
          <div className="flex flex-wrap gap-1.5">
            {recent.map((term) => (
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl border px-2.5 py-1 text-[11px] transition-colors [background-color:hsl(var(--command-surface-raised))] [border-color:hsl(var(--command-border))] hover:[background-color:hsl(var(--command-accent))]"
              >
