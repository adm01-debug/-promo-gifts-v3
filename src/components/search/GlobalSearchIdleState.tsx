...
function NavCard({
  ...
  return (
    ...
    >
      ...
      {action.shortcut && (
        <kbd className="hidden h-5 min-w-[22px] items-center justify-center rounded-xl border border-primary/20 bg-primary/10 px-1.5 font-mono text-[10px] font-semibold text-primary/60 md:inline-flex">
          {action.shortcut}
        </kbd>
      )}
      <ArrowUpRight
            ...
            {history.slice(0, 4).map((term, i) => (
              ...
              >
                ...
                <button
                  ...
                  className="flex h-7 w-7 items-center justify-center rounded-xl opacity-0 transition-all hover:bg-destructive/10 group-hover:opacity-100 group-data-[selected=true]:opacity-100"
                >
                  <X
          ...
          <div className="space-y-1 px-2">
            {popularProducts.map((product, idx) => (
              ...
              >
                ...
                {idx === 0 ? (
                  <Badge className="h-6 shrink-0 rounded-xl border-orange/20 bg-gradient-to-r from-orange/20 to-orange/10 text-[10px] font-semibold text-orange shadow-sm shadow-orange/10 hover:bg-orange/25">
                    🔥 Top 1
                  </Badge>
                ) : (
