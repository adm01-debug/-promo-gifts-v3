    ...
    <>
      ...
      <div className="flex items-center gap-2 w-full md:w-auto">
        ...
        >
          ...
          <kbd className="hidden sm:inline-flex items-center gap-0.5 px-1.5 py-0.5 rounded-lg border border-border/50 bg-muted/50 text-[10px] font-medium text-muted-foreground/60 group-hover:border-primary/20 group-hover:text-primary/50 transition-colors shrink-0">⌘K</kbd>
        </button>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="outline" size="icon" onClick={s.handleOpenVoiceOverlay} className="shrink-0 h-10 w-10 rounded-lg border-border/50 hover:bg-primary/10 hover:text-primary hover:border-primary/40 transition-all" aria-label="Microfone"><Mic className="h-4 w-4" /></Button>
          </TooltipTrigger>
      ...
      <CommandDialog open={s.open} onOpenChange={s.setOpen}>
        ...
        <CommandList className="max-h-[520px] scrollbar-thin px-1 [background-color:hsl(var(--command-surface))]">
          ...
          {s.isAIProcessing && (
            <div className="flex items-center gap-3 px-4 py-3.5 mx-2 mt-3 rounded-lg bg-gradient-to-r from-primary/12 via-primary/6 to-primary/3 border border-primary/15 shadow-sm shadow-primary/5 animate-in fade-in-0 slide-in-from-top-2 duration-300">
              <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-primary/25 to-primary/5 flex items-center justify-center shadow-inner">
          ...
          {s.searchIntent && !s.isSearching && s.results.length > 0 && (
            <div className="flex flex-wrap items-center gap-2 px-4 py-3 mx-2 mt-3 rounded-lg border [border-color:hsl(var(--command-border))] [background:linear-gradient(90deg,hsl(var(--command-surface-raised)),hsl(var(--command-surface)))] animate-in fade-in-0 slide-in-from-top-1 duration-200">
          ...
          {s.isSearching && !s.isAIProcessing && (
            <div className="flex flex-col items-center justify-center py-16 gap-4 animate-in fade-in-0 duration-300">
              <div className="relative">
                <div className="h-14 w-14 rounded-lg bg-gradient-to-br from-primary/15 to-primary/5 flex items-center justify-center shadow-lg shadow-primary/10">
              ...
              <CommandGroup key={type} heading={config.label + "s"} className="animate-in fade-in-0 slide-in-from-bottom-2 duration-300 [&_[cmdk-group-heading]]:px-4 [&_[cmdk-group-heading]]:pt-4 [&_[cmdk-group-heading]]:pb-2">
                {items.map((result, i) => (
                  <CommandItem
                    ...
                    className={cn("flex items-center gap-3.5 py-3 rounded-lg mx-2 px-3 animate-in fade-in-0 slide-in-from-bottom-1 duration-200", paletteItemStateClass)}
                    style={staggerStyle(i, 50)}
                  >
                    <div className={cn("h-10 w-10 rounded-lg flex items-center justify-center shrink-0 shadow-sm", `${config.color}/10`)}>
          ...
          {s.typingSuggestions.length > 0 && s.query.length >= 2 && s.query.length < 5 && !s.isSearching && (
            <CommandGroup heading="Sugestões" className="animate-in fade-in-0 duration-200">
              {s.typingSuggestions.map((suggestion, i) => (
                ...
                >
                  <div className="h-9 w-9 rounded-lg bg-gradient-to-br from-primary/12 to-primary/4 flex items-center justify-center">
        ...
        <div className="flex items-center justify-between px-5 py-2.5 border-t [border-color:hsl(var(--command-border))] [background:linear-gradient(90deg,hsl(var(--command-surface-raised)),hsl(var(--command-surface)),hsl(var(--command-surface-raised)))] select-none">
          <div className="flex items-center gap-4 text-[11px] [color:hsl(var(--command-text-subtle))]">
            <span className="inline-flex items-center gap-1.5">
              <kbd className="inline-flex items-center justify-center h-[18px] min-w-[20px] rounded-lg [background-color:hsl(var(--command-accent))] border [border-color:hsl(var(--command-border))] font-mono text-[10px] leading-none px-1">↵</kbd>
            ...
            <span className="hidden md:inline-flex items-center gap-1.5">
              <kbd className="inline-flex items-center justify-center h-[18px] min-w-[20px] rounded-lg [background-color:hsl(var(--command-accent))] border [border-color:hsl(var(--command-border))] font-mono text-[10px] leading-none px-1">1-9</kbd>
              <span>Saltar</span>
            </span>
            <span className="hidden md:inline-flex items-center gap-1.5">
              <kbd className="inline-flex items-center justify-center h-[18px] rounded-lg [background-color:hsl(var(--command-accent))] border [border-color:hsl(var(--command-border))] font-mono text-[10px] leading-none px-1">⌘↵</kbd>
              <span>Nova aba</span>
            </span>
            <span className="inline-flex items-center gap-1.5">
              <kbd className="inline-flex items-center justify-center h-[18px] min-w-[20px] rounded-lg [background-color:hsl(var(--command-accent))] border [border-color:hsl(var(--command-border))] font-mono text-[10px] leading-none px-1">ESC</kbd>
              <span>Fechar</span>
            </span>
          </div>
          <div className="flex items-center gap-1.5 text-[10px] text-primary/40 font-medium">
            <div className="h-4 w-4 rounded-lg bg-primary/8 flex items-center justify-center"><Brain className="h-2.5 w-2.5" /></div>
