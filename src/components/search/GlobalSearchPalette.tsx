    ...
    <>
      ...
      <div className="flex w-full items-center gap-2 md:w-auto">
        <button
          ...
          className="group relative flex flex-1 items-center gap-2.5 overflow-hidden rounded-xl border px-3.5 py-2 text-sm transition-all duration-300 [background-color:hsl(var(--command-surface-raised))] [border-color:hsl(var(--command-border))] hover:[background-color:hsl(var(--command-surface-soft))] hover:[border-color:hsl(var(--command-border-strong))] md:w-64"
        >
          <div className="pointer-events-none absolute inset-0 bg-gradient-to-r from-primary/0 via-primary/[0.03] to-primary/0 transition-all duration-500 group-hover:via-primary/[0.06]" />
          <div className="bg-primary/8 group-hover:bg-primary/12 relative flex h-6 w-6 shrink-0 items-center justify-center rounded-xl transition-colors duration-300">
            <Brain className="h-3.5 w-3.5 text-primary/60 transition-colors duration-300 group-hover:text-primary" />
            <div className="pointer-events-none absolute inset-0 animate-[brain-glow_3s_ease-in-out_infinite] rounded-xl bg-primary/10" />
          </div>
          <span className="relative flex-1 text-left text-[13px] transition-colors duration-300 [color:hsl(var(--command-text-muted))] group-hover:text-foreground">
            Busca inteligente...
          </span>
          <kbd className="hidden shrink-0 items-center gap-0.5 rounded-xl border border-border/50 bg-muted/50 px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground/60 transition-colors group-hover:border-primary/20 group-hover:text-primary/50 sm:inline-flex">
            ⌘K
          </kbd>
        </button>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              className="h-10 w-10 shrink-0 rounded-xl border-border/50 transition-all hover:border-primary/40 hover:bg-primary/10 hover:text-primary"
      ...
      <CommandDialog open={s.open} onOpenChange={s.setOpen}>
        ...
        <CommandList className="scrollbar-thin max-h-[520px] px-1 [background-color:hsl(var(--command-surface))]">
          ...
          {s.isAIProcessing && (
            <div className="from-primary/12 via-primary/6 to-primary/3 mx-2 mt-3 flex items-center gap-3 rounded-xl border border-primary/15 bg-gradient-to-r px-4 py-3.5 shadow-sm shadow-primary/5 duration-300 animate-in fade-in-0 slide-in-from-top-2">
          ...
          {s.searchIntent && !s.isSearching && s.results.length > 0 && (
            <div className="mx-2 mt-3 flex flex-wrap items-center gap-2 rounded-xl border px-4 py-3 duration-200 animate-in fade-in-0 slide-in-from-top-1 [background:linear-gradient(90deg,hsl(var(--command-surface-raised)),hsl(var(--command-surface)))] [border-color:hsl(var(--command-border))]">
              <div className="bg-primary/12 flex h-6 w-6 items-center justify-center rounded-xl">
              ...
              {s.searchIntent.type !== 'mixed' && typeConfig[s.searchIntent.type] && (
                <Badge
                  variant="outline"
                  className="h-5.5 rounded-xl text-[11px] font-semibold [background-color:hsl(var(--command-accent))] [border-color:hsl(var(--command-border-strong))]"
                >
              ...
              {s.searchIntent.filters.category && (
                <Badge
                  variant="secondary"
                  className="h-5.5 rounded-xl text-[11px] [background-color:hsl(var(--command-accent))] [color:hsl(var(--command-text-muted))]"
                >
                  {s.searchIntent.filters.category}
                </Badge>
              )}
          ...
          {s.isSearching && !s.isAIProcessing && (
            <div className="flex flex-col items-center justify-center gap-4 py-16 duration-300 animate-in fade-in-0">
              <div className="relative">
                <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-gradient-to-br from-primary/15 to-primary/5 shadow-lg shadow-primary/10">
                  <Loader2 className="h-6 w-6 animate-spin text-primary/70" />
                </div>
                <div className="absolute inset-0 animate-ping rounded-xl bg-primary/10 opacity-30" />
              </div>
          ...
          {!s.isSearching && s.query.length >= 1 && s.query.length < 3 && (
            <div className="flex items-center justify-center gap-2.5 px-4 py-8 duration-200 animate-in fade-in-0">
              <div className="flex h-7 w-7 items-center justify-center rounded-xl [background-color:hsl(var(--command-accent))]">
                ...
                >
                  {items.map((result, i) => (
                    ...
                    >
                      ...
                      <Badge
                        variant="outline"
                        className="h-5 shrink-0 rounded-xl text-[10px] font-medium [background-color:hsl(var(--command-accent))] [border-color:hsl(var(--command-border-strong))]"
                      >
                        {config.label}
                      </Badge>
        ...
        <div className="flex select-none items-center justify-between border-t px-5 py-2.5 [background:linear-gradient(90deg,hsl(var(--command-surface-raised)),hsl(var(--command-surface)),hsl(var(--command-surface-raised)))] [border-color:hsl(var(--command-border))]">
          <div className="flex items-center gap-4 text-[11px] [color:hsl(var(--command-text-subtle))]">
            <span className="inline-flex items-center gap-1.5">
              <kbd className="inline-flex h-[18px] min-w-[20px] items-center justify-center rounded-xl border px-1 font-mono text-[10px] leading-none [background-color:hsl(var(--command-accent))] [border-color:hsl(var(--command-border))]">
                ↵
              </kbd>
            ...
            <span className="hidden items-center gap-1.5 md:inline-flex">
              <kbd className="inline-flex h-[18px] items-center justify-center rounded-xl border px-1 font-mono text-[10px] leading-none [background-color:hsl(var(--command-accent))] [border-color:hsl(var(--command-border))]">
                ⌘↵
              </kbd>
              <span>Nova aba</span>
            </span>
          ...
          <div className="flex items-center gap-1.5 text-[10px] font-medium text-primary/40">
            <div className="bg-primary/8 flex h-4 w-4 items-center justify-center rounded-xl">
