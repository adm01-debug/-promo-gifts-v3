...
import { Search, Filter, Navigation, ArrowUpDown, Trash2, HelpCircle } from 'lucide-react';
      ...
      <AnimatePresence mode="wait">
        {showTranscript && (
          <motion.div
            ...
            className="w-full"
          >
            <div className="rounded-xl border border-white/[0.08] bg-white/[0.06] px-5 py-4 backdrop-blur-sm">
      ...
      <AnimatePresence>
        {error && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -10 }}
            className="w-full rounded-xl border border-destructive/20 bg-destructive/10 px-5 py-4"
          >
            <div className="flex items-start gap-3">
