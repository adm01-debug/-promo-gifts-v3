      ...
      <div className="flex items-center gap-3 p-3 rounded-xl bg-muted/40 border border-border/50">
        {product.images?.[0] && (
          <img
            ...
            alt={product.name}
            className="w-12 h-12 rounded-2xl object-cover border border-border/60 shrink-0 shadow-sm"
          />
        )}
            ...
            >
              {variant.selected_thumbnail ? (
                <img
                  ...
                  className="w-10 h-10 rounded-2xl object-cover border border-border/50 shrink-0 shadow-sm group-hover:scale-105 transition-transform"
                  onError={(e) => {
                ...
                <div
                  className="w-10 h-10 rounded-2xl border border-border/50 shrink-0 shadow-sm group-hover:scale-105 transition-transform"
