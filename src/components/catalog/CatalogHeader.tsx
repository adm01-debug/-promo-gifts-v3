  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3">
      <div className="flex min-w-0 flex-1 items-center gap-3">
        ...
        <h1 className="whitespace-nowrap font-display text-xl font-bold sm:text-2xl lg:text-3xl">
        ...
        <div className="hidden w-80 items-center gap-2 sm:flex lg:w-[32rem]" ref={searchRef}>
          <SmartSearchInput
