                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <PopoverTrigger asChild>
                        <Button variant="outline" size="icon" className="h-11 w-11 shrink-0 rounded-2xl border-muted-foreground/20 hover:border-primary/50 relative group overflow-hidden" aria-label="Histórico de buscas recentes">
                ...
                <PopoverContent className="w-64 p-2" align="end">
                  ...
                  <div className="space-y-1 max-h-60 overflow-y-auto pr-1">
                    {searchHistory.map((term, i) => (
                      <button
                        key={i}
                        className="w-full flex items-center gap-2 px-3 py-2 text-sm rounded-2xl hover:bg-accent text-left group transition-colors"
                        onClick={() => {
