                ...
                {m.selectedClient ? (
                  <div className="flex items-center gap-3 p-2 rounded-lg bg-primary/5 border border-primary/20">
                    {m.selectedClient.logo_url && (
                      <img src={m.selectedClient.logo_url} alt="" className="w-8 h-8 rounded object-contain bg-background border" />
                    )}
                  ...
                  <div className="flex gap-4">
                    {m.currentImage && (
                      <div className="w-24 h-24 rounded-lg overflow-hidden bg-background border shrink-0">
                        <img src={m.currentImage} alt={m.selectedProduct.name} className="w-full h-full object-contain" />
                      </div>
                    )}
                    ...
                    {m.logoUploading ? (
                      ...
                      <>
                        <div className="w-20 h-20 rounded-lg overflow-hidden bg-background border">
                          <img src={m.logoPreview} alt="Logo" className="w-full h-full object-contain" />
                        </div>
