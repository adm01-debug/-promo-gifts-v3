...
export default function ComparePage() {
  ...
  const { compareItems, removeByIndex, clearCompare, compareCount, addToCompare } =
    useComparisonStore();
  ...
  if (compareCount < 2) {
    const handleLoadMocks = async (ids: string[]) => {
      ...
      try {
        ...
        if (limitReached) {
          toast.warning(`Limite de 12 itens atingido. ${addedCount} adicionados.`, {
            id: 'mock-loading',
          });
        } else if (addedCount > 0) {
          toast.success(
            `Simulação concluída: ${addedCount} itens na Arena${skippedCount > 0 ? ` (${skippedCount} duplicados ignorados)` : ''}`,
            { id: 'mock-loading' },
          );
        } else {
        ...
        <div className="flex flex-col items-center gap-4 pb-20">
          <div className="flex flex-wrap justify-center gap-3">
            <Button
              ...
              className="gap-2 border-amber-500/30 bg-amber-500/5 text-[10px] font-black uppercase tracking-widest hover:border-amber-500"
          ...
          <p className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-600/50">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1
                ...
                className="font-display text-xl font-bold text-foreground lg:text-3xl"
              >
          ...
          <div className="flex flex-wrap gap-2">
            <Popover>
              <TooltipProvider>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <PopoverTrigger asChild>
                      <Button
                        ...
                        size="sm"
                        className={cn(client && 'border-none bg-amber-500 hover:bg-amber-600')}
                      >
                  ...
                  <TooltipContent className="border-none bg-primary px-2 py-1 text-[11px] font-medium text-primary-foreground shadow-xl">
                    Vincular comparação a um cliente
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className={cn(differencesOnly && 'border-none bg-amber-500 hover:bg-amber-600')}
                  >
                ...
                <TooltipContent className="border-none bg-primary px-2 py-1 text-[11px] font-medium text-primary-foreground shadow-xl">
                  Destacar apenas atributos diferentes entre os produtos{' '}
                  <kbd className="ml-1 rounded bg-primary-foreground/20 px-1 py-0.5 font-mono text-[10px] text-primary-foreground">
                    D
                  </kbd>
                </TooltipContent>
              </Tooltip>
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button
                    ...
                    className="border-none bg-amber-500 font-bold hover:bg-amber-600"
                  >
                ...
                <TooltipContent className="border-none bg-primary px-2 py-1 text-[11px] font-medium text-primary-foreground shadow-xl">
                  Enviar produtos comparados para novo orçamento
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
            ...
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="border-none bg-primary px-2 py-1 text-[11px] font-medium text-primary-foreground shadow-xl">
                  Gerar link público de comparação
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent className="border-none bg-primary px-2 py-1 text-[11px] font-medium text-primary-foreground shadow-xl">
                  Remover todos os produtos da comparação
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
