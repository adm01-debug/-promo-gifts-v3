        ...
        <Card className="space-y-3 border-border/30 p-4 shadow-sm">
          ...
          {cartAge >= 3 && (
            <motion.p
              ...
              className="flex items-center gap-2 rounded-xl border border-destructive/10 bg-destructive/5 px-3 py-2.5 text-[10px] font-bold text-destructive"
            >
            ...
            >
              {c.company_logo_url ? (
                <img
                  ...
                  alt=""
                  className="h-8 w-8 rounded-lg border border-border/50 bg-background object-contain p-0.5"
                  loading="lazy"
                />
              ) : (
