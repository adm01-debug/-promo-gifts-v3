        ...
        <Tabs defaultValue="anomalias" className="w-full">
          ...
          <TabsContent value="anomalias" className="space-y-3">
            ...
            <Card>
              ...
              <CardContent className="space-y-2 text-[11px] font-medium text-muted-foreground">
                <p>
                  • <strong className="text-foreground">Falhas de login &gt; 50/24h</strong>:
                  possível brute-force — verifique aba "Bot Detection" e use blocklist.
                </p>
                <p>
                  • <strong className="text-foreground">Bots bloqueados &gt; 100</strong>: scraping
                  ativo — confirme padrão de IPs e bloqueie em massa.
                </p>
                <p>
                  • <strong className="text-foreground">Falhas de token &gt; 20</strong>: tentativa
                  de adivinhação — token é auto-expirado após 5 falhas/hora.
                </p>
                <p>
                  • <strong className="text-foreground">IPs distintos em tokens &gt; 30</strong>:
                  possível link vazado — revogue tokens do recurso afetado.
                </p>
                <p className="border-t border-border/50 pt-2 text-[10px] font-bold uppercase tracking-wider text-primary">
                  Em caso de comprometimento confirmado, use{' '}
