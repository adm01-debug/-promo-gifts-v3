  ...
  return (
    <div className="container mx-auto max-w-3xl space-y-6 p-6">
      <PageSEO
        ...
        description="Estime custos de personalização rapidamente."
      />
      <header className="space-y-1">
        <h1
          data-testid="page-title-simulador-personalizacao"
      ...
      <Card className="border-primary">
        ...
        <CardContent className="space-y-2 text-sm">
          <p>
            Área: <strong>{area} cm²</strong>
          </p>
          <p>
            Total estimado: <strong className="text-xl text-primary">R$ {total.toFixed(2)}</strong>
          </p>
          <p className="text-xs text-muted-foreground">
            Estimativa didática — não consulta as tabelas oficiais de gravação. Para o cálculo real
            (áreas, técnicas, faixas e valores cadastrados), use o Simulador (wizard).
          </p>
        </CardContent>
      </Card>
    </div>
