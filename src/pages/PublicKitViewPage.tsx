          ...
          <Card>
            ...
            <CardContent>
              <div className="flex items-center gap-4">
                {kit.box.imageUrl && (
                  <img src={kit.box.imageUrl} alt={kit.box.name} className="w-20 h-20 object-contain rounded-lg border bg-muted/50" />
                )}
                <div>
            ...
            <div className="divide-y">
              {kit.items.map((item, idx) => (
                <div key={idx} className="flex items-center gap-4 py-3 first:pt-0 last:pb-0">
                  {item.imageUrl ? (
                    <img src={item.imageUrl} alt={item.name} className="w-14 h-14 object-contain rounded-lg border bg-muted/50 flex-shrink-0" />
                  ) : (
