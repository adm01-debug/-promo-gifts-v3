...
export const ACCESS_DENIED_STRINGS: Record<Role, RoleCopy> = {
  ...
  supervisor: {
    ...
    intro: "Como supervisor, você administra usuários, empresas e regras de negócio — mas ferramentas técnicas ficam restritas ao time de Desenvolvimento.",
  ...
  agente: {
    ...
    intro: "Como vendedor, você não precisa acessar páginas técnicas para o seu dia a dia. O catálogo e CRM já cobrem suas necessidades.",
