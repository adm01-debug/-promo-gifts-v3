...
CREATE INDEX idx_rls_denial_user ON public.rls_denial_log (user_id, created_at DESC);
CREATE INDEX idx_rls_denial_table ON public.rls_denial_log (table_name, created_at DESC);
CREATE INDEX idx_rls_denial_created ON public.rls_denial_log (created_at DESC);
