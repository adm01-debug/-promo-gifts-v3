...
CREATE INDEX idx_step_up_challenges_user ON public.step_up_challenges(user_id, created_at DESC);
CREATE INDEX idx_step_up_challenges_expires ON public.step_up_challenges(expires_at) WHERE consumed = false;
...
CREATE INDEX idx_step_up_tokens_hash ON public.step_up_tokens(token_hash) WHERE consumed = false;
CREATE INDEX idx_step_up_tokens_user ON public.step_up_tokens(user_id, created_at DESC);
...
CREATE INDEX idx_step_up_audit_user ON public.step_up_audit_log(user_id, created_at DESC);
CREATE INDEX idx_step_up_audit_action ON public.step_up_audit_log(action, created_at DESC);
