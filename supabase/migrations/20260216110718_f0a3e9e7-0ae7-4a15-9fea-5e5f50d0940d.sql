...
CREATE INDEX idx_magic_up_generations_user ON public.magic_up_generations(user_id, created_at DESC);
CREATE INDEX idx_magic_up_generations_favorite ON public.magic_up_generations(user_id, is_favorite) WHERE is_favorite = true;
