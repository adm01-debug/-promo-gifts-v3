...
CREATE INDEX idx_companies_nome_fantasia ON public.companies(nome_fantasia);
CREATE INDEX idx_companies_razao_social ON public.companies(razao_social);
CREATE INDEX idx_companies_status ON public.companies(status);
CREATE INDEX idx_companies_ramo ON public.companies(ramo);
CREATE INDEX idx_companies_responsavel ON public.companies(responsavel_id);
CREATE INDEX idx_companies_bitrix ON public.companies(bitrix_id);

CREATE INDEX idx_contacts_company ON public.company_contacts(company_id);
CREATE INDEX idx_contacts_nome ON public.company_contacts(nome);
CREATE INDEX idx_contacts_principal ON public.company_contacts(company_id, is_principal) WHERE is_principal = true;

CREATE INDEX idx_phones_contact ON public.contact_phones(contact_id);
CREATE INDEX idx_emails_contact ON public.contact_emails(contact_id);
CREATE INDEX idx_addresses_company ON public.company_addresses(company_id);
