...
CREATE INDEX idx_favorite_lists_user ON public.favorite_lists(user_id, position);
CREATE INDEX idx_favorite_lists_shared_token ON public.favorite_lists(shared_token) WHERE shared_token IS NOT NULL;
CREATE UNIQUE INDEX idx_favorite_lists_one_default
...
CREATE INDEX idx_favorite_items_user ON public.favorite_items(user_id);
CREATE INDEX idx_favorite_items_list ON public.favorite_items(list_id, position);
CREATE INDEX idx_favorite_items_product ON public.favorite_items(product_id);
...
CREATE INDEX idx_favorite_items_trash_user ON public.favorite_items_trash(user_id, deleted_at DESC);
CREATE INDEX idx_favorite_items_trash_expires ON public.favorite_items_trash(expires_at);
