...
CREATE INDEX idx_ownership_repair_logs_report ON public.ownership_repair_logs(report_id);
CREATE INDEX idx_ownership_repair_logs_created_at ON public.ownership_repair_logs(created_at DESC);
