...
CREATE INDEX idx_kit_variants_master ON public.kit_variants(kit_master_id);
...
CREATE INDEX idx_kit_collab_kit ON public.kit_collaborators(kit_id);
CREATE INDEX idx_kit_collab_user ON public.kit_collaborators(user_id);
...
CREATE INDEX idx_kit_comments_kit ON public.kit_comments(kit_id);
CREATE INDEX idx_kit_comments_parent ON public.kit_comments(parent_id);
