...
CREATE TABLE public.future_stock_entries (
...
CREATE INDEX idx_future_stock_product_id ON public.future_stock_entries(product_id);
CREATE INDEX idx_future_stock_expected_date ON public.future_stock_entries(expected_date);
CREATE INDEX idx_future_stock_status ON public.future_stock_entries(status);
CREATE INDEX idx_future_stock_color ON public.future_stock_entries(color_name);
