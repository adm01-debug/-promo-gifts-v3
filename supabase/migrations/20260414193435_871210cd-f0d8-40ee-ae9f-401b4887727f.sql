...
-- 6. Indexes
CREATE INDEX idx_discount_approval_requests_quote_id ON public.discount_approval_requests(quote_id);
CREATE INDEX idx_discount_approval_requests_seller_id ON public.discount_approval_requests(seller_id);
CREATE INDEX idx_discount_approval_requests_status ON public.discount_approval_requests(status);
CREATE INDEX idx_seller_discount_limits_user_id ON public.seller_discount_limits(user_id);
