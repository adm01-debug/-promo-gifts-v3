...
describe('Acesso a /admin/conexoes', () => {
  ...
  it('redireciona para / quando o usuário é manager (canManage mas não admin)', () => {
    // Defesa em profundidade: AdminRoute libera manager, mas o requireAdmin
    // aninhado deve bloquear o acesso a credenciais sensíveis.
    mockUseAuth.mockReturnValue({
      ...baseAuth,
      user: { id: 'u-2' },
      canManage: true,
